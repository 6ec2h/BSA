...
function modifier_box_ability:IsHidden() return true end
function modifier_box_ability:IsPurgable() return false end
function modifier_box_ability:RemoveOnDeath() return false end
