...
function sunstrike_ultra_lua:OnSpellStart()    
	...
	for _,enemy in pairs(enemies) do 
        if enemy:IsAlive() then 
            local point = enemy:GetAbsOrigin()
			local startFX = ParticleManager:CreateParticle("particles/units/heroes/hero_invoker/invoker_sun_strike_team.vpcf", PATTACH_ABSORIGIN, enemy)
...
function overgrowth_ultra_lua:Precache( context )
	PrecacheResource( "particle", "particles/econ/items/lone_druid/lone_druid_cauldron/lone_druid_bear_entangle_cauldron.vpcf", context )
end
...
function modifier_overgrowth_ultra_lua:IsHidden() return false end
function modifier_overgrowth_ultra_lua:IsDebuff() return true end
function modifier_overgrowth_ultra_lua:IsPurgable() return false end
function modifier_overgrowth_ultra_lua:RemoveOnDeath() return true end
...
function mine_ultra_lua:OnSpellStart()
	...
	for _,enemy in pairs(enemies) do 
        if enemy:IsAlive() then 
            local point = enemy:GetAbsOrigin()
            local mine = CreateUnitByName("npc_zone_8_creep_land_mines", point + RandomVector( RandomInt( 0, 150 )), true, nil, nil, caster:GetTeamNumber())
...
function modifier_mine_ultra_lua_thinker:IsHidden() return true end
...
function poison_ultra_lua:OnSpellStart()
    ...
    for _, enemy in pairs(enemies) do 
        if enemy:IsAlive() then 
            ...
            local effect_cast = ParticleManager:CreateParticle("particles/units/heroes/hero_venomancer/venomancer_poison_nova.vpcf", PATTACH_ABSORIGIN_FOLLOW, enemy)
...
function modifier_venomancer_poison_nova_lua:IsHidden() return false end
function modifier_venomancer_poison_nova_lua:IsDebuff() return true end
function modifier_venomancer_poison_nova_lua:IsPurgable() return false end
...
function modifier_blind_ultra_lua:IsHidden() return false end
function modifier_blind_ultra_lua:IsDebuff() return true end
function modifier_blind_ultra_lua:IsPurgable() return false end
...
function modifier_resist_ultra_lua:IsHidden() return false end
function modifier_resist_ultra_lua:IsDebuff() return true end
function modifier_resist_ultra_lua:IsPurgable() return false end
...
function modifier_ice_ultra_lua:IsHidden() return false end
function modifier_ice_ultra_lua:IsDebuff() return true end
function modifier_ice_ultra_lua:IsPurgable() return false end
