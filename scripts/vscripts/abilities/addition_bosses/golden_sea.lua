...
LinkLuaModifier("modifier_golden_sea_anti_fervor_passive", "abilities/addition_bosses/golden_sea", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_golden_sea_anti_fervor_debuff", "abilities/addition_bosses/golden_sea", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_golden_sea_anti_fervor_buff", "abilities/addition_bosses/golden_sea", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_golden_sea_anti_fervor_base", "abilities/addition_bosses/golden_sea", LUA_MODIFIER_MOTION_NONE)
...
function modifier_golden_sea_anti_fervor_passive:IsHidden() return true end
function modifier_golden_sea_anti_fervor_passive:IsPurgable() return false end
function modifier_golden_sea_anti_fervor_passive:RemoveOnDeath() return false end
...
function modifier_golden_sea_anti_fervor_passive:OnAttackLanded(keys)
    ...
    if keys.attacker == parent and not parent:PassivesDisabled() then
        ...
        local enemy_modifier = target:AddNewModifier(parent, ability, "modifier_golden_sea_anti_fervor_debuff", { duration = duration })
        if enemy_modifier then
            enemy_modifier:AddStack(duration)
        end

        local self_modifier = parent:AddNewModifier(parent, ability, "modifier_golden_sea_anti_fervor_buff", { duration = duration })
...
function modifier_golden_sea_anti_fervor_base:IsHidden() return false end
function modifier_golden_sea_anti_fervor_base:IsPurgable() return false end
...
function modifier_golden_sea_anti_fervor_debuff:GetTexture() return "troll_warlord_fervor" end
...
function modifier_golden_sea_anti_fervor_buff:GetTexture() return "troll_warlord_fervor" end
...
function modifier_golden_sea_turbulence:IsDebuff() return true end
function modifier_golden_sea_turbulence:IsPurgable() return true end
...
function modifier_golden_sea_turbulence:OnCreated()
    ...
    self.pfx = ParticleManager:CreateParticle("particles/units/heroes/hero_brewmaster/brewmaster_cyclone.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetParent())
...
function modifier_golden_sea_hydro:IsHidden() return true end
function modifier_golden_sea_hydro:IsPurgable() return true end
...
function modifier_golden_sea_hydro:OnAttackLanded(params)
    ...
    if not modifier then
        modifier = target:AddNewModifier(caster, ability, "modifier_golden_sea_hydro_stack", { duration = duration })
    end
...
LinkLuaModifier("modifier_golden_sea_mirror_surface", "abilities/addition_bosses/golden_sea", LUA_MODIFIER_MOTION_NONE)
...
function modifier_golden_sea_mirror_surface:IsHidden() return false end
...
function golden_sea_illusion:OnSpellStart()
    ...
    for _, enemy in pairs(enemies) do
        ...
        for _, illusion in pairs(illusions) do
            ...
            local pfx = ParticleManager:CreateParticle("particles/units/heroes/hero_dark_seer/dark_seer_wall_of_replica_replicate.vpcf", PATTACH_ABSORIGIN_FOLLOW, illusion)
...
function modifier_golden_sea_illusion:IsHidden() return true end
