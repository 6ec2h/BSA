LinkLuaModifier("modifier_golden_forest_death_investment", "abilities/addition_bosses/golden_forest", LUA_MODIFIER_MOTION_NONE)
...
function modifier_golden_forest_death_investment:IsPurgable() return false end
...
function modifier_golden_forest_death_investment:OnCreated()
    ...
    local pfx = ParticleManager:CreateParticle("particles/units/heroes/hero_clinkz/clinkz_strafe_fire.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetParent())
...
function modifier_golden_forest_death_investment:OnDestroy()
    ...
    if self.has_attacked then
		...
		ParticleManager:SetParticleControlEnt(sapFX, 1, parent, PATTACH_POINT_FOLLOW, "attach_hitloc",
...
function modifier_golden_forest_death_investment:GetEffectName() return "particles/units/heroes/hero_bane/bane_enfeeble.vpcf" end

function modifier_golden_forest_death_investment:GetEffectAttachType() return PATTACH_OVERHEAD_FOLLOW end