...
LinkLuaModifier("modifier_golden_dragon_blinding_lua_debuff", "abilities/addition_bosses/golden_dragon", LUA_MODIFIER_MOTION_NONE)
...
function golden_dragon_blinding_lua:OnSpellStart()
    ...
    local particle = ParticleManager:CreateParticle("particles/versus/compendium_2024_versus_light_burst.vpcf", PATTACH_ABSORIGIN, caster)
...
function modifier_golden_dragon_blinding_lua_debuff:IsPurgable() return true end
...
function modifier_golden_dragon_blinding_lua_debuff:ShowTimer()
    local pfx = ParticleManager:CreateParticle("particles/units/heroes/hero_alchemist/alchemist_unstable_concoction_timer.vpcf", PATTACH_OVERHEAD_FOLLOW, self:GetParent())
...
function modifier_golden_dragon_blinding_lua_debuff:OnDestroy()
    ...
    local particle = ParticleManager:CreateParticle("particles/units/heroes/hero_techies/techies_land_mine_explode.vpcf", PATTACH_ABSORIGIN, target)
    ParticleManager:ReleaseParticleIndex(particle)
...
LinkLuaModifier("modifier_golden_dragon_greed_thinker", "abilities/addition_bosses/golden_dragon", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_golden_dragon_greed_buff", "abilities/addition_bosses/golden_dragon", LUA_MODIFIER_MOTION_NONE)
...
function modifier_golden_dragon_greed_buff:IsPurgable() return false end
...
function modifier_golden_dragon_greed_buff:GetAbsoluteNoDamageMagical() return 1 end
function modifier_golden_dragon_greed_buff:GetAbsoluteNoDamagePhysical() return 1 end
function modifier_golden_dragon_greed_buff:GetAbsoluteNoDamagePure() return 1 end
...
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
LinkLuaModifier("modifier_golden_dragon_solar_wind_burn", "abilities/addition_bosses/golden_dragon", LUA_MODIFIER_MOTION_NONE)
...
function modifier_golden_dragon_solar_wind_burn:IsPurgable() return true end
...
LinkLuaModifier("modifier_golden_dragon_vacuum_dash_motion", "abilities/addition_bosses/golden_dragon", LUA_MODIFIER_MOTION_HORIZONTAL)
...
function modifier_golden_dragon_vacuum_dash_motion:IsHidden() return true end
function modifier_golden_dragon_vacuum_dash_motion:IsPurgable() return false end
...
function modifier_golden_dragon_vacuum_dash_motion:OnCreated(kv)
    ...
    self.effect_cast = ParticleManager:CreateParticle("particles/golden_dragon/golden_dragon_move.vpcf", PATTACH_ABSORIGIN_FOLLOW, self.parent)
