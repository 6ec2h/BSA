...
LinkLuaModifier("modifier_golden_wyvern_aura_debuff", "abilities/addition_bosses/golden_wyvern", LUA_MODIFIER_MOTION_NONE)
...
function modifier_golden_wyvern_aura:IsHidden() return true end
function modifier_golden_wyvern_aura:IsAura() return true end
...
function modifier_golden_wyvern_aura_debuff:IsDebuff() return true end
function modifier_golden_wyvern_aura_debuff:IsPurgable() return false end
...
LinkLuaModifier("modifier_golden_wyvern_splinter_blast_colba", "abilities/addition_bosses/golden_wyvern", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_golden_wyvern_splinter_blast_splinter_charge", "abilities/addition_bosses/golden_wyvern", LUA_MODIFIER_MOTION_NONE)
...
function golden_wyvern_splinter_blast:OnProjectileHit_ExtraData(target, location, ExtraData)
	if target and target:IsAlive() and not target:HasModifier("modifier_silence") then 
		...
		target:AddNewModifier(caster, self, "modifier_golden_wyvern_splinter_blast_colba", {duration = ExtraData.slow_duration * (1 - target:GetStatusResistance())});
