...
LinkLuaModifier( "modifier_hidden_earth_boss_split_earth", "abilities/addition_bosses/hidden_earth_boss", LUA_MODIFIER_MOTION_NONE )
...
function hidden_earth_boss_split_earth:OnSpellStart()
	...
	CreateModifierThinker(caster, self, "modifier_hidden_earth_boss_split_earth", { duration = delay }, point, caster:GetTeamNumber(), false)
end
...
----------------------------------------------------------------------------
----------------------------------------------------------------------------
LinkLuaModifier( "modifier_hidden_earth_boss_fissure_lua_thinker", "abilities/addition_bosses/hidden_earth_boss", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_hidden_earth_boss_fissure_pass", "abilities/addition_bosses/hidden_earth_boss", LUA_MODIFIER_MOTION_NONE )
...
function hidden_earth_boss_fissure_lua:OnSpellStart()
    ...
    local units = FindUnitsInLine(caster:GetTeamNumber(), start_pos, end_pos, nil, radius, DOTA_UNIT_TARGET_TEAM_BOTH, DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC, 0)
...
function hidden_earth_boss_fissure_lua:PlayEffects( start_pos, end_pos, duration )
    local caster = self:GetCaster()
    local effect_cast = ParticleManager:CreateParticle( "particles/units/heroes/hero_earthshaker/earthshaker_fissure.vpcf", PATTACH_WORLDORIGIN, caster )
...
function modifier_hidden_earth_boss_fissure_lua_thinker:IsAura() return true end
function modifier_hidden_earth_boss_fissure_lua_thinker:GetModifierAura() return "modifier_hidden_earth_boss_fissure_pass" end
function modifier_hidden_earth_boss_fissure_lua_thinker:GetAuraRadius() return 120 end
function modifier_hidden_earth_boss_fissure_lua_thinker:GetAuraSearchTeam() return DOTA_UNIT_TARGET_TEAM_FRIENDLY end
function modifier_hidden_earth_boss_fissure_lua_thinker:GetAuraSearchType() return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC end
...
function modifier_hidden_earth_boss_fissure_pass:IsHidden() return true end
...
LinkLuaModifier("modifier_hidden_earth_boss_magnetize_lua", "abilities/addition_bosses/hidden_earth_boss", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_hidden_earth_boss_minion_root", "abilities/addition_bosses/hidden_earth_boss", LUA_MODIFIER_MOTION_NONE)
...
function modifier_hidden_earth_boss_magnetize_lua:OnCreated()
    ...
    self.damage = (self:GetAbility():GetSpecialValueFor("damage_per_second") + self:GetAbility():GetSpecialValueFor("diff_boost_damage")) * interval
    self.radius = self:GetAbility():GetSpecialValueFor("radius")
...
function modifier_hidden_earth_boss_magnetize_lua:OnIntervalThink()
    ...
    local tickParticle = ParticleManager:CreateParticle("particles/units/heroes/hero_earth_spirit/espirit_magnetize_target.vpcf", PATTACH_ABSORIGIN_FOLLOW, target)
