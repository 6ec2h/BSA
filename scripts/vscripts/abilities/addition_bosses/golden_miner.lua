...
LinkLuaModifier("modifier_golden_miner_crushing_rift", "abilities/addition_bosses/golden_miner", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_golden_miner_fracture_debuff", "abilities/addition_bosses/golden_miner", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_golden_miner_flesh_weight_aura", "abilities/addition_bosses/golden_miner", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_golden_miner_flesh_weight_debuff", "abilities/addition_bosses/golden_miner", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_golden_miner_flesh_weight_debuff_timeout", "abilities/addition_bosses/golden_miner", LUA_MODIFIER_MOTION_NONE)
...
function modifier_golden_miner_flesh_weight_aura:IsHidden() return true end
function modifier_golden_miner_flesh_weight_aura:IsAura() return true end
    ...
    if distance <= min_dist then
        ...
        if self.counter >= duration + 1 then
            if not parent:HasModifier("modifier_golden_miner_flesh_weight_debuff_timeout") then
                parent:AddNewModifier(caster, self:GetAbility(), "modifier_golden_miner_petrified", {duration = duration})
                parent:AddNewModifier(caster, self:GetAbility(), "modifier_golden_miner_flesh_weight_debuff_timeout", {duration = duration + 3})
                self.counter = 0
            end
        end
    else
...
function golden_miner_rock_throw:OnSpellStart()
    ...
    if not target_enemy then return end
...
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
LinkLuaModifier("modifier_golden_miner_death_nova_pull", "abilities/addition_bosses/golden_miner", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_golden_miner_death_nova_vortex", "abilities/addition_bosses/golden_miner", LUA_MODIFIER_MOTION_NONE)
...
function modifier_golden_miner_death_nova_pull:OnDestroy()
    ...
    local source = caster
    if not source or source:IsNull() then source = parent end 
    ...
    local pfx = ParticleManager:CreateParticle("particles/units/heroes/hero_techies/techies_remote_mines_detonate.vpcf", PATTACH_WORLDORIGIN, nil)
