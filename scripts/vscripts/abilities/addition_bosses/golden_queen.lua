...
LinkLuaModifier("modifier_golden_queen_field_thinker", "abilities/addition_bosses/golden_queen", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_golden_queen_field_slow", "abilities/addition_bosses/golden_queen", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_golden_queen_field_freeze", "abilities/addition_bosses/golden_queen", LUA_MODIFIER_MOTION_NONE)
...
function modifier_golden_queen_field_thinker:OnCreated()
    ...
    self.preFX = ParticleManager:CreateParticle("particles/units/heroes/hero_ancient_apparition/ancient_ice_vortex.vpcf", PATTACH_ABSORIGIN, self:GetParent())
...
LinkLuaModifier("modifier_golden_queen_aero_echo_thinker", "abilities/addition_bosses/golden_queen", LUA_MODIFIER_MOTION_NONE)

golden_queen_aero_echo = class({})

function golden_queen_aero_echo:Precache( context )
	PrecacheResource( "particle", "particles/econ/items/invoker/invoker_apex/invoker_sun_strike_team_glow_small2_immortal1.vpcf", context )
...
function modifier_golden_queen_aero_echo:IsHidden() return true end
...
function modifier_golden_queen_aero_echo:OnTakeDamage(params)
    ...
    if ability and attacker:GetTeamNumber() ~= params.unit:GetTeamNumber() then
        ...
        local pfx = ParticleManager:CreateParticle("particles/econ/items/invoker/invoker_apex/invoker_sun_strike_team_glow_small2_immortal1.vpcf", PATTACH_WORLDORIGIN, nil)
