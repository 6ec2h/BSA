...
function modifier_spike_trap_thinker_lua:OnCreated( kv )
	...
	self.light_strike_array_damage = self:GetAbility():GetSpecialValueFor( "light_strike_array_damage" ) + self:GetAbility():GetSpecialValueFor( "diff_boost_damage" )
...
function simple_roll_shot:OnSpellStart()
    ...
    CreateModifierThinker(
        caster, 
        self, 
        "modifier_simple_roll_shot_thinker", 
        {}, 
        point, 
        caster:GetTeamNumber(), 
        false
