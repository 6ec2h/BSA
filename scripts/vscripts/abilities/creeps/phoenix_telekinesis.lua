LinkLuaModifier("modifier_phoenix_telekinesis", "abilities/creeps/phoenix_telekinesis", LUA_MODIFIER_MOTION_BOTH)
LinkLuaModifier("modifier_phoenix_telekinesis_stun", "abilities/creeps/phoenix_telekinesis", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_phoenix_telekinesis_root", "abilities/creeps/phoenix_telekinesis", LUA_MODIFIER_MOTION_NONE)

phoenix_telekinesis = class({})
function phoenix_telekinesis:IsHiddenWhenStolen() return false end
function phoenix_telekinesis:IsRefreshable() return true end
function phoenix_telekinesis:IsStealable() return true end
function phoenix_telekinesis:IsNetherWardStealable() return true end
-------------------------------------------

function phoenix_telekinesis:OnSpellStart( params )
...
modifier_phoenix_telekinesis = class({})
function modifier_phoenix_telekinesis:IsDebuff()
	if self:GetParent():GetTeamNumber() ~= self:GetCaster():GetTeamNumber() then return true end
	return false
end
function modifier_phoenix_telekinesis:IsHidden() return false end
function modifier_phoenix_telekinesis:IsPurgable() return false end
function modifier_phoenix_telekinesis:IsPurgeException() return false end
function modifier_phoenix_telekinesis:IsStunDebuff() return false end
function modifier_phoenix_telekinesis:IgnoreTenacity() return true end
function modifier_phoenix_telekinesis:IsMotionController() return true end
function modifier_phoenix_telekinesis:GetMotionControllerPriority() return DOTA_MOTION_CONTROLLER_PRIORITY_MEDIUM end

function modifier_phoenix_telekinesis:OnCreated( params )
...
function modifier_phoenix_telekinesis:OnIntervalThink()
	if IsServer() then
...
function modifier_phoenix_telekinesis:EndTransition()
	if IsServer() then
		...
		parent:RemoveModifierByName("modifier_phoenix_telekinesis_stun")
		parent:RemoveModifierByName("modifier_phoenix_telekinesis_root")
...
function modifier_phoenix_telekinesis:VerticalMotion(unit, dt)
	if IsServer() then
...
function modifier_phoenix_telekinesis:HorizontalMotion(unit, dt)
	if IsServer() then
...
function modifier_phoenix_telekinesis:GetTexture()
	return "rubick_telekinesis"
end

function modifier_phoenix_telekinesis:OnDestroy()
	if IsServer() then
...
-------------------------------------------
modifier_phoenix_telekinesis_stun = class({})
function modifier_phoenix_telekinesis_stun:IsDebuff() return true end
function modifier_phoenix_telekinesis_stun:IsHidden() return false end
function modifier_phoenix_telekinesis_stun:IsPurgable() return false end
function modifier_phoenix_telekinesis_stun:IsPurgeException() return false end
function modifier_phoenix_telekinesis_stun:IsStunDebuff() return true end

function modifier_phoenix_telekinesis_stun:DeclareFunctions()
	local decFuns =
		{
...
function modifier_phoenix_telekinesis_stun:GetOverrideAnimation()
	return ACT_DOTA_FLAIL
end

function modifier_phoenix_telekinesis_stun:CheckState()
	local state =
		{
...
modifier_phoenix_telekinesis_root = class({})
function modifier_phoenix_telekinesis_root:IsDebuff() return false end
function modifier_phoenix_telekinesis_root:IsHidden() return true end
function modifier_phoenix_telekinesis_root:IsPurgable() return false end
function modifier_phoenix_telekinesis_root:IsPurgeException() return false end
function modifier_phoenix_telekinesis_root:OnCreated()

	self:StartIntervalThink(0.2)
end

function modifier_phoenix_telekinesis_root:OnIntervalThink()
if IsServer() then
	ApplyDamage( {
...
function modifier_phoenix_telekinesis_root:CheckState()
	local state =
		{
