...
function modifier_creep_sand_corpse_eater_lua:IsHidden() return false end
function modifier_creep_sand_corpse_eater_lua:IsPurgable() return false end
function modifier_creep_sand_corpse_eater_lua:RemoveOnDeath() return false end
...
function modifier_creep_sand_corpse_eater_lua:OnDeath(params)
    ...
    if not unit or unit == parent or unit:GetTeamNumber() ~= parent:GetTeamNumber() then return end
    if unit:IsIllusion() or unit:IsBuilding() then return end
    if not parent:IsAlive() then return end

    local radius = ability:GetSpecialValueFor("radius")
    if (parent:GetAbsOrigin() - unit:GetAbsOrigin()):Length2D() > radius then return end
    ...
    local pfx = ParticleManager:CreateParticle("particles/units/heroes/hero_life_stealer/ls_infest_emerg_blood.vpcf", PATTACH_ABSORIGIN_FOLLOW, parent)
    ParticleManager:ReleaseParticleIndex(pfx)
end

function modifier_creep_sand_corpse_eater_lua:GetModifierExtraHealthBonus() return self.bonus_hp end
function modifier_creep_sand_corpse_eater_lua:GetModifierPreAttack_BonusDamage() return self.bonus_damage end
function modifier_creep_sand_corpse_eater_lua:GetModifierPhysicalArmorBonus() return self.bonus_armor end
function modifier_creep_sand_corpse_eater_lua:GetModifierModelScale() return self.model_scale end
...
function modifier_creep_sand_pack_call_lua:IsHidden() return true end
...
function modifier_creep_sand_pack_call_lua:OnTakeDamage(params)
    ...
    if params.unit ~= parent or not ability:IsCooldownReady() then return end
...
function modifier_creep_sand_pack_buff_lua:OnIntervalThink()
    ...
    if not self.target or self.target:IsNull() or not self.target:IsAlive() or self.target:IsInvulnerable() or self.target:IsAttackImmune() then
        self:Destroy()
        return
    end
...
function modifier_creep_sand_pack_buff_lua:GetModifierMoveSpeedBonus_Percentage() return self.ms end
function modifier_creep_sand_pack_buff_lua:GetModifierAttackSpeedBonus_Constant() return self.as end
function modifier_creep_sand_pack_buff_lua:GetEffectName() return "particles/units/heroes/hero_lycan/lycan_howl_buff.vpcf" end
...
function modifier_creep_sand_impale_lua:IsHidden() return true end
...
function modifier_creep_sand_shift_motion:OnCreated(kv)
    ...
    self.effect_cast = ParticleManager:CreateParticle("particles/units/heroes/hero_sandking/sandking_sandstorm.vpcf", PATTACH_ABSORIGIN_FOLLOW, self.parent)
    ParticleManager:SetParticleControlEnt(self.effect_cast, 0, self.parent, PATTACH_ABSORIGIN_FOLLOW, "attach_hitloc", self.parent:GetOrigin(), true)
...
function modifier_creep_sand_shift_motion:OnDestroy()
    ...
    local pfx2 = ParticleManager:CreateParticle("particles/units/heroes/hero_sandking/sandking_sandstorm_start.vpcf", PATTACH_ABSORIGIN, self.parent)
...
function modifier_creep_sand_toss_lua:IsDebuff() return true end
function modifier_creep_sand_toss_lua:IsStunDebuff() return true end
function modifier_creep_sand_toss_lua:RemoveOnDeath() return false end
function modifier_creep_sand_toss_lua:IsHidden() return true end
function modifier_creep_sand_toss_lua:IgnoreTenacity() return true end
function modifier_creep_sand_toss_lua:IsMotionController() return true end
function modifier_creep_sand_toss_lua:GetMotionControllerPriority() return DOTA_MOTION_CONTROLLER_PRIORITY_MEDIUM end
function modifier_creep_sand_toss_lua:IsPurgable() return false end
...
function modifier_creep_sand_shimmer_aura_lua_buff:IsHidden() return false end
...
function modifier_all_reduction_aura_passive:OnCreated()
    ...
    self.particle = ParticleManager:CreateParticle("particles/units/heroes/hero_faceless_void/faceless_void_chronosphere.vpcf", PATTACH_ABSORIGIN_FOLLOW, caster)
    ParticleManager:SetParticleControlEnt(self.particle, 0, caster, PATTACH_ABSORIGIN_FOLLOW, "attach_origin", caster:GetAbsOrigin(), true)
