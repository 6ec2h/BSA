LinkLuaModifier("modifier_invoker_meteor", "abilities/creeps/invoker_meteor", LUA_MODIFIER_MOTION_VERTICAL)
LinkLuaModifier("modifier_invoker_meteor_thinker", "abilities/creeps/invoker_meteor", LUA_MODIFIER_MOTION_VERTICAL)
LinkLuaModifier("modifier_invoker_meteor_burn", "abilities/creeps/invoker_meteor", LUA_MODIFIER_MOTION_VERTICAL)

invoker_meteor = class({})

function invoker_meteor:OnSpellStart()

	self.mod_caster = self:GetCaster():AddNewModifier(self:GetCaster(), self, "modifier_invoker_meteor", {duration = 2})
end
