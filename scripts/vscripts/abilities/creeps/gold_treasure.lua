...
function modifier_gold_modifier:IsHidden() return true end
function modifier_gold_modifier:IsPurgable() return false end
function modifier_gold_modifier:RemoveOnDeath() return false end
