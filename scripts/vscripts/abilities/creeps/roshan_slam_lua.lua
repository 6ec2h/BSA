...
function roshan_slam_lua:OnSpellStart()
    ...
    local particle = ParticleManager:CreateParticle("particles/units/heroes/hero_ursa/ursa_earthshock.vpcf", PATTACH_ABSORIGIN, caster)
...
function modifier_roshan_slam_lua_slow:IsHidden() return false end
function modifier_roshan_slam_lua_slow:IsDebuff() return true end
function modifier_roshan_slam_lua_slow:IsPurgable() return true end
