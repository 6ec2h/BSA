...
function modifier_boss_damage_boost:IsHidden() return true end
function modifier_boss_damage_boost:IsPurgable() return false end
function modifier_boss_damage_boost:RemoveOnDeath() return false end
function modifier_boss_damage_boost:IsPermanent() return true end
