...
function modifier_temple_guardian_hammer_throw:OnCreated( kv )
	if IsServer() then
		self.hammer_damage = self:GetAbility():GetSpecialValueFor( "hammer_damage" ) + self:GetAbility():GetSpecialValueFor( "diff_boost_damage" )
...
function modifier_temple_guardian_wrath_thinker:OnCreated( kv )
	if IsServer() then
		...
		self.radius = self:GetAbility():GetSpecialValueFor( "radius" )
		self.blast_damage = self:GetAbility():GetSpecialValueFor( "blast_damage" ) + self:GetAbility():GetSpecialValueFor( "diff_boost_damage" )
