...
LinkLuaModifier( "modifier_boss_ursa_fury_swipes_lua", "abilities/bosses/ursa/boss_ursa_fury_swipes_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ursa_fury_swipes_debuff_lua", "abilities/bosses/ursa/boss_ursa_fury_swipes_lua", LUA_MODIFIER_MOTION_NONE )
