LinkLuaModifier("modifier_necro_blast", "abilities/bosses/final/necro_blast.lua", LUA_MODIFIER_MOTION_NONE)

necro_blast = class({})

function necro_blast:GetIntrinsicModifierName()
	return "modifier_necro_blast"
end

----------------------------------------------------------------------------------

modifier_necro_blast = class({})

function modifier_necro_blast:IsHidden()
    return true
end

function modifier_necro_blast:OnCreated()
...
function modifier_necro_blast:OnIntervalThink()
