...
function boss_necro_firestorm:OnSpellStart()
	CreateModifierThinker( self:GetCaster(), self, "modifier_boss_necro_firestorm_thinker",  {}, self:GetCaster():GetAbsOrigin(), self:GetCaster():GetTeamNumber(), false )
end
...
function modifier_boss_necro_firestorm_thinker:OnCreated( kv )
	...
	self.burn_damage = self.ability:GetSpecialValueFor( "burn_damage" ) + self.ability:GetSpecialValueFor( "diff_boost_additional" )
...
function boss_necro_spike:Precache( context )
    PrecacheResource( "particle", "particles/econ/items/leshrac/leshrac_tormented_staff_retro/leshrac_split_retro_d_tormented.vpcf", context )
...
function modifier_boss_necro_spike:IsHidden() return false end
function modifier_boss_necro_spike:IsPurgable() return false end
...
function modifier_boss_necro_spike:OnIntervalThink()  
    ...
    Timers:CreateTimer(delay, function()
        ...
        local particle_blast_fx = ParticleManager:CreateParticle("particles/econ/items/leshrac/leshrac_tormented_staff_retro/leshrac_split_retro_d_tormented.vpcf", PATTACH_WORLDORIGIN, nil)
...
function modifier_boss_necro_passive:IsHidden() return false end 
function modifier_boss_necro_passive:IsPurgable() return false end
...
function modifier_necro_boss_necro_spawn_lua:IsHidden() return true end
function modifier_necro_boss_necro_spawn_lua:IsPurgable() return false end
...
function modifier_necro_boss_necro_spawn_lua_effect:IsHidden() return true end
function modifier_necro_boss_necro_spawn_lua_effect:IsPurgable() return false end
