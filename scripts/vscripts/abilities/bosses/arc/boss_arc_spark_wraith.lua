LinkLuaModifier("modifier_boss_arc_spark_wraith_thinker", "abilities/bosses/arc/boss_arc_spark_wraith", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_arc_spark_wraith_purge", "abilities/bosses/arc/boss_arc_spark_wraith", LUA_MODIFIER_MOTION_NONE)
