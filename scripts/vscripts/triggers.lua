...
function add_quest_3(trigger)
    ...
    if not _G.players_quest_progress["additional"][104] then
        ...
        if condition and _G.players_quest_progress["additional"][condition] and _G.players_quest_progress["additional"][condition].completed == true then
...
function reward()
	...
	local particleLeader = ParticleManager:CreateParticle("particles/dire_fx/fire_barracks.vpcf", PATTACH_WORLDORIGIN, nil)
