...
function modifier_hidan_ritual_of_blood:IsHidden()    return false end
function modifier_hidan_ritual_of_blood:IsPurgable()  return false end
function modifier_hidan_ritual_of_blood:IsPermanent() return true  end
