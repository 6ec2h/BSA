...
function modifier_sasori_red_secret:IsHidden()    return true  end
function modifier_sasori_red_secret:IsPurgable()  return false end
function modifier_sasori_red_secret:IsPermanent() return true  end
...
function modifier_sasori_poison:IsHidden()   return false end
function modifier_sasori_poison:IsDebuff()   return true  end
function modifier_sasori_poison:IsPurgable() return false end
