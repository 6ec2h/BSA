...
function modifier_kisame_samehada_hunger:IsHidden()    return true  end
function modifier_kisame_samehada_hunger:IsPurgable()  return false end
function modifier_kisame_samehada_hunger:IsPermanent() return true  end
...
function modifier_kisame_samehada_hunger:OnAttackLanded(data)
    ...
    if actual_burn <= 0 then return end
    ...
    target:AddNewModifier(caster, self:GetAbility(), 'modifier_kisame_magic_resist_debuff',
...
function modifier_kisame_magic_resist_debuff:IsHidden()   return false end
function modifier_kisame_magic_resist_debuff:IsDebuff()   return true  end
function modifier_kisame_magic_resist_debuff:IsPurgable() return true  end
