LinkLuaModifier("modifier_monkey_king_boundless_strike_lua_crit", "heroes/hero_monkey_king/monkey_king_boundless_strike_lua/monkey_king_boundless_strike_lua", LUA_MODIFIER_MOTION_NONE)
