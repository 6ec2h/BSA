LinkLuaModifier("modifier_monkey_king_wukongs_command_lua_solider_status", "heroes/hero_monkey_king/monkey_king_wukongs_command_lua/monkey_king_wukongs_command_lua", LUA_MODIFIER_MOTION_NONE)
