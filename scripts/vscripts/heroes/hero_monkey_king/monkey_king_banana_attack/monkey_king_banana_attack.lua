LinkLuaModifier("modifier_monkey_king_banana_attack", "heroes/hero_monkey_king/monkey_king_banana_attack/monkey_king_banana_attack", LUA_MODIFIER_MOTION_NONE)
