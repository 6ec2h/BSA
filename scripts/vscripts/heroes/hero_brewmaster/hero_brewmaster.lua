LinkLuaModifier('modifier_brewmaster_thunder_clap_lua_debuff',  "heroes/hero_brewmaster/hero_brewmaster", LUA_MODIFIER_MOTION_NONE)
...
function modifier_brewmaster_thunder_clap_lua_debuff:IsHidden() return false end
function modifier_brewmaster_thunder_clap_lua_debuff:IsPurgable() return true end
function modifier_brewmaster_thunder_clap_lua_debuff:IsDebuff() return true end
function modifier_brewmaster_thunder_clap_lua_debuff:IsBuff() return false end
function modifier_brewmaster_thunder_clap_lua_debuff:RemoveOnDeath() return true end
function modifier_brewmaster_thunder_clap_lua_debuff:AllowIllusionDuplicate() return true end
...
LinkLuaModifier('modifier_brewmaster_cinder_brew_lua_debuff', "heroes/hero_brewmaster/hero_brewmaster", LUA_MODIFIER_MOTION_NONE)
...
function brewmaster_cinder_brew_lua:OnProjectileHit(hTarget, vLocation)
    ...
    local caster = self:GetCaster()
    local units = FindUnitsInRadius(caster:GetTeam(), vLocation, nil, self:GetSpecialValueFor('radius'), DOTA_UNIT_TARGET_TEAM_ENEMY, DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC, self:GetAbilityTargetFlags(), FIND_ANY_ORDER, false)
    local duration = self:GetSpecialValueFor('duration')
...
function modifier_brewmaster_cinder_brew_lua_debuff:IsHidden() return false end
function modifier_brewmaster_cinder_brew_lua_debuff:IsPurgable() return true end
function modifier_brewmaster_cinder_brew_lua_debuff:IsDebuff() return true end
function modifier_brewmaster_cinder_brew_lua_debuff:IsBuff() return false end
function modifier_brewmaster_cinder_brew_lua_debuff:RemoveOnDeath() return true end
function modifier_brewmaster_cinder_brew_lua_debuff:AllowIllusionDuplicate() return true end
...
function modifier_brewmaster_cinder_brew_lua_debuff:OnTakeDamage(keys)
	...
	if self.bIgnited then return end

	if not keys.inflictor or keys.inflictor:IsNull() then return end
	if keys.inflictor:GetAbilityName() ~= "brewmaster_thunder_clap_lua" then return end
...
LinkLuaModifier('modifier_brewmaster_drunken_brawler_lua_buff', "heroes/hero_brewmaster/hero_brewmaster", LUA_MODIFIER_MOTION_NONE)
...
function modifier_brewmaster_drunken_brawler_lua_buff:IsHidden() return false end
function modifier_brewmaster_drunken_brawler_lua_buff:IsPurgable() return true end
function modifier_brewmaster_drunken_brawler_lua_buff:IsDebuff() return false end
function modifier_brewmaster_drunken_brawler_lua_buff:IsBuff() return true end
function modifier_brewmaster_drunken_brawler_lua_buff:RemoveOnDeath() return true end
function modifier_brewmaster_drunken_brawler_lua_buff:AllowIllusionDuplicate() return true end
