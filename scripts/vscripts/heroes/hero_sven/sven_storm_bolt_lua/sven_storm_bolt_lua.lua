LinkLuaModifier( "modifier_sven_storm_bolt_lua", "heroes/hero_sven/sven_storm_bolt_lua/sven_storm_bolt_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_sven_storm_bolt_buff_lua", "heroes/hero_sven/sven_storm_bolt_lua/sven_storm_bolt_lua", LUA_MODIFIER_MOTION_NONE )
...
function sven_storm_bolt_lua:OnProjectileHit( hTarget, vLocation )
	if hTarget ~= nil and ( not hTarget:IsInvulnerable() ) and ( not hTarget:TriggerSpellAbsorb( self ) ) then
		...
		self:GetCaster():AddNewModifier(self:GetCaster(), self, "modifier_sven_storm_bolt_buff_lua", { duration = bolt_stun_duration } )
