LinkLuaModifier( "modifier_sven_gods_strength_lua", "heroes/hero_sven/sven_gods_strength_lua/sven_gods_strength_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_sven_gods_strength_child_lua", "heroes/hero_sven/sven_gods_strength_lua/sven_gods_strength_lua", LUA_MODIFIER_MOTION_NONE )
