...
LinkLuaModifier( "modifier_disruptor_static_storm_lua", "heroes/hero_disruptor/disruptor_static_storm_lua/disruptor_static_storm_lua", LUA_MODIFIER_MOTION_NONE )
