...
LinkLuaModifier( "modifier_disruptor_kinetic_field_lua", "heroes/hero_disruptor/disruptor_kinetic_field_lua/disruptor_kinetic_field_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_resist", "heroes/hero_disruptor/disruptor_kinetic_field_lua/disruptor_kinetic_field_lua", LUA_MODIFIER_MOTION_NONE )
...
function modifier_resist:OnCreated( kv )
	self.resist = self:GetAbility():GetSpecialValueFor( "resist" ) * (-1) -- special value
end

function modifier_resist:OnRefresh( kv )
	self.resist = self:GetAbility():GetSpecialValueFor( "resist" ) * (-1)-- special value
end

function modifier_resist:OnDestroy( kv )
