...
function modifier_centaur_repel_lua:OnDestroy( kv )
	if IsServer() then
		...
		if self:GetCaster():FindAbilityByName("npc_dota_hero_centaur_int9")~=nil then
			if self:GetCaster():FindAbilityByName("npc_dota_hero_centaur_int9"):GetLevel() > 0 then 
...
function modifier_centaur_repel_lua:GetModifierAttackSpeedBonus_Constant()
	if self:GetCaster():FindAbilityByName("npc_dota_hero_centaur_agi9")~=nil then
		if self:GetCaster():FindAbilityByName("npc_dota_hero_centaur_agi9"):GetLevel() > 0 then 
