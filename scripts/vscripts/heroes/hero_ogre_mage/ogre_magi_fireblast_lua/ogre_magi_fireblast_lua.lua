LinkLuaModifier( "modifier_ogre_magi_fireblast_lua_talent", "heroes/hero_ogre_mage/ogre_magi_fireblast_lua/ogre_magi_fireblast_lua", LUA_MODIFIER_MOTION_NONE )
...
function modifier_ogre_magi_fireblast_lua_talent:OnRefresh( kv )
end

function modifier_ogre_magi_fireblast_lua_talent:OnRemoved()
end

function modifier_ogre_magi_fireblast_lua_talent:OnDestroy()
end
