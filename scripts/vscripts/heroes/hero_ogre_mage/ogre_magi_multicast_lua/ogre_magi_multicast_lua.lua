LinkLuaModifier( "modifier_ogre_magi_multicast_lua", "heroes/hero_ogre_mage/ogre_magi_multicast_lua/ogre_magi_multicast_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ogre_magi_multicast_lua_proc", "heroes/hero_ogre_mage/ogre_magi_multicast_lua/ogre_magi_multicast_lua", LUA_MODIFIER_MOTION_NONE )
