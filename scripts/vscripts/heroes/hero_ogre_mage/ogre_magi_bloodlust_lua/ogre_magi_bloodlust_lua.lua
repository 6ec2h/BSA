...
LinkLuaModifier( "modifier_ogre_magi_bloodlust_lua", "heroes/hero_ogre_mage/ogre_magi_bloodlust_lua/ogre_magi_bloodlust_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ogre_magi_bloodlust_lua_buff", "heroes/hero_ogre_mage/ogre_magi_bloodlust_lua/ogre_magi_bloodlust_lua", LUA_MODIFIER_MOTION_NONE )
