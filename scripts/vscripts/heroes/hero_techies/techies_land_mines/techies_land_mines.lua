...
LinkLuaModifier("modifier_range_indicator", "heroes/hero_techies/techies_land_mines/techies_land_mines.lua", LUA_MODIFIER_MOTION_NONE)
...
function techies_land_mines_lua:CastFilterResultLocation(location)
	if IsServer() then
		...
		local friendly_units = FindUnitsInRadius(caster:GetTeamNumber(), location, nil, radius, DOTA_UNIT_TARGET_TEAM_FRIENDLY, DOTA_UNIT_TARGET_ALL, DOTA_UNIT_TARGET_FLAG_INVULNERABLE, FIND_ANY_ORDER, false)
...
function modifier_range_indicator:IsDebuff() return false end
function modifier_range_indicator:IsHidden() return true end
function modifier_range_indicator:IsPurgable() return false end
function modifier_range_indicator:IsPurgeException() return false end
function modifier_range_indicator:IsStunDebuff() return false end
function modifier_range_indicator:RemoveOnDeath() return self.bRemoveOnDeath end
