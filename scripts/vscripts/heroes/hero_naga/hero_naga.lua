...
function naga_siren_mirror_image_lua:OnSpellStart()
    ...
    local illusions = CreateIllusions(caster, caster, { outgoing_damage = 0, incoming_damage = incoming }, count, 72, false, true)
    if illusions then
...
function modifier_illusion_naga_siren_mirror_image_lua:IsHidden() return true end
...
function modifier_naga_siren_mirror_image_lua:IsHidden() return true end
function modifier_naga_siren_mirror_image_lua:IsPurgable() return false end
...
function modifier_naga_siren_ensnare_lua:IsHidden() return false end
function modifier_naga_siren_ensnare_lua:IsDebuff() return true end
function modifier_naga_siren_ensnare_lua:IsPurgable() return true end
function modifier_naga_siren_ensnare_lua:GetPriority() return MODIFIER_PRIORITY_HIGH end
...
function modifier_naga_siren_rip_tide_lua:TriggerRipTide()
    self:Proc()
     ...
     for illusion,_ in pairs(self:GetAbility().illusions) do
        if illusion:IsIllusion() and illusion:GetPlayerOwner() == self:GetParent():GetPlayerOwner() and illusion:IsAlive() then
...
function modifier_naga_siren_rip_tide_lua:Proc()
    ...
    for _, enemy in pairs(enemies) do
        enemy:AddNewModifier(self.caster, self:GetAbility(), "modifier_naga_siren_rip_tide_lua_debuff", { duration = self.duration })
    ...
    local pfx = ParticleManager:CreateParticle("particles/units/heroes/hero_siren/naga_siren_riptide.vpcf", PATTACH_ABSORIGIN_FOLLOW, self.parent)
...
function modifier_naga_siren_rip_tide_lua_debuff:IsDebuff() return true end
function modifier_naga_siren_rip_tide_lua_debuff:IsPurgable() return true end
...
LinkLuaModifier("modifier_naga_siren_song_of_the_siren_lua_buff", "heroes/hero_naga/hero_naga", LUA_MODIFIER_MOTION_NONE)
...
function modifier_naga_siren_song_of_the_siren_lua:IsHidden() return false end
function modifier_naga_siren_song_of_the_siren_lua:IsPurgable() return false end
...
function modifier_naga_siren_song_of_the_siren_lua:OnCreated()
    ...
    local cast_pfx = ParticleManager:CreateParticle("particles/units/heroes/hero_siren/naga_siren_siren_song_cast.vpcf", PATTACH_ABSORIGIN_FOLLOW, caster)
    ParticleManager:ReleaseParticleIndex(cast_pfx)

    self.main_pfx = ParticleManager:CreateParticle("particles/units/heroes/hero_siren/naga_siren_song_aura.vpcf", PATTACH_ABSORIGIN_FOLLOW, caster)
    ParticleManager:SetParticleControlEnt(self.main_pfx, 0, caster, PATTACH_POINT_FOLLOW, "attach_hitloc", Vector(0,0,0), true)
...
function modifier_naga_siren_song_of_the_siren_lua:IsAura() return true end
function modifier_naga_siren_song_of_the_siren_lua:GetModifierAura() return "modifier_naga_siren_song_of_the_siren_lua_buff" end
function modifier_naga_siren_song_of_the_siren_lua:GetAuraRadius() return self.radius end
function modifier_naga_siren_song_of_the_siren_lua:GetAuraSearchTeam() return DOTA_UNIT_TARGET_TEAM_FRIENDLY end
function modifier_naga_siren_song_of_the_siren_lua:GetAuraSearchType() return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC end
function modifier_naga_siren_song_of_the_siren_lua:GetAuraSearchFlags() return DOTA_UNIT_TARGET_FLAG_INVULNERABLE end

--------------------------------------------------------------------------------

modifier_naga_siren_song_of_the_siren_lua_buff = class({})

function modifier_naga_siren_song_of_the_siren_lua_buff:IsHidden() return false end
function modifier_naga_siren_song_of_the_siren_lua_buff:IsPurgable() return false end
function modifier_naga_siren_song_of_the_siren_lua_buff:GetAttributes() return MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE end
...
function modifier_naga_siren_song_of_the_siren_lua_buff:GetModifierMagicalResistanceBonus() return self.res end
function modifier_naga_siren_song_of_the_siren_lua_buff:GetModifierHealthRegenPercentageUnique() return self.regen end
...
function modifier_naga_siren_song_of_the_siren_lua_buff:StatusEffectPriority() return MODIFIER_PRIORITY_NORMAL end