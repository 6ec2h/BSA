...
LinkLuaModifier("modifier_imba_void_ministun", "heroes/hero_night_stalker/night_stalker_void_lua/night_stalker_void_lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_void_slow", "heroes/hero_night_stalker/night_stalker_void_lua/night_stalker_void_lua", LUA_MODIFIER_MOTION_NONE)
...
function night_stalker_void_lua:OnSpellStart()    
	...
	local enemies = FindUnitsInRadius(caster:GetTeamNumber(), target_point, nil, 250, DOTA_UNIT_TARGET_TEAM_ENEMY, DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC, DOTA_UNIT_TARGET_FLAG_NONE, FIND_ANY_ORDER, false)
