...
LinkLuaModifier( "modifier_night_stalker_blood","heroes/hero_night_stalker/night_stalker_blood/night_stalker_blood", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_night_stalker_blood_effect","heroes/hero_night_stalker/night_stalker_blood/night_stalker_blood", LUA_MODIFIER_MOTION_NONE )
...
function modifier_night_stalker_blood:OnDestroy( kv )
