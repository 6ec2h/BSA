...
LinkLuaModifier("modifier_night_stalker_hunter_in_the_night_lua_thinker", "heroes/hero_night_stalker/night_stalker_hunter_in_the_night_lua/night_stalker_hunter_in_the_night_lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_night_stalker_hunter_in_the_night_lua", "heroes/hero_night_stalker/night_stalker_hunter_in_the_night_lua/night_stalker_hunter_in_the_night_lua", LUA_MODIFIER_MOTION_NONE)
...
modifier_night_stalker_hunter_in_the_night_lua_thinker = modifier_night_stalker_hunter_in_the_night_lua_thinker or class({})
function modifier_night_stalker_hunter_in_the_night_lua_thinker:IsHidden() return true end
function modifier_night_stalker_hunter_in_the_night_lua_thinker:IsPurgable() return false end
function modifier_night_stalker_hunter_in_the_night_lua_thinker:IsDebuff() return false end
...
function modifier_night_stalker_hunter_in_the_night_lua:IsHidden() return false end
function modifier_night_stalker_hunter_in_the_night_lua:IsPurgable() return false end
function modifier_night_stalker_hunter_in_the_night_lua:IsDebuff() return false end
