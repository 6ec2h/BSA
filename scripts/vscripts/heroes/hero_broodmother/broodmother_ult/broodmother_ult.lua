...
function modifier_broodmother_ult:OnDeath( params )
	...
	if attacker ~= parent or attacker:HasModifier("modifier_guild_event") then return end

	local target = params.unit
	if target == parent or target:IsBuilding() or target:IsIllusion() then return end
