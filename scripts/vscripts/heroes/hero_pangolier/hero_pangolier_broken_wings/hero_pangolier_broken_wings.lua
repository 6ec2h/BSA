LinkLuaModifier( "modifier_hero_pangolier_broken_wings", "heroes/hero_pangolier/hero_pangolier_broken_wings/hero_pangolier_broken_wings", LUA_MODIFIER_MOTION_NONE )
...
function hero_pangolier_broken_wings:OnSpellStart()
	...
	local enemies = FindUnitsInLine(caster:GetTeamNumber(), origin, point, nil, width, DOTA_UNIT_TARGET_TEAM_ENEMY, DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC, 0)
