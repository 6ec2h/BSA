LinkLuaModifier( "modifier_hero_pangolier_blade_of_the_exile", "heroes/hero_pangolier/hero_pangolier_blade_of_the_exile/hero_pangolier_blade_of_the_exile", LUA_MODIFIER_MOTION_NONE )
