LinkLuaModifier( "modifier_hero_pangolier_runic_blade", "heroes/hero_pangolier/hero_pangolier_runic_blade/hero_pangolier_runic_blade", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_hero_pangolier_runic_blade_stack", "heroes/hero_pangolier/hero_pangolier_runic_blade/hero_pangolier_runic_blade", LUA_MODIFIER_MOTION_NONE )
