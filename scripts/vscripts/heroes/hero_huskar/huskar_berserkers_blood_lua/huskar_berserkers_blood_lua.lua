LinkLuaModifier( "modifier_huskar_berserkers_blood_lua", "heroes/hero_huskar/huskar_berserkers_blood_lua/huskar_berserkers_blood_lua", LUA_MODIFIER_MOTION_NONE )
