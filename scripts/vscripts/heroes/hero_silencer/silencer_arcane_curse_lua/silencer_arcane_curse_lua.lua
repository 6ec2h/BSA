...
LinkLuaModifier( "modifier_silencer_arcane_curse_lua", "heroes/hero_silencer/silencer_arcane_curse_lua/modifier_silencer_arcane_curse_lua", LUA_MODIFIER_MOTION_NONE )
