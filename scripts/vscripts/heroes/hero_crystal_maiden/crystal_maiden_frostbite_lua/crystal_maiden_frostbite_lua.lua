...
LinkLuaModifier( "modifier_crystal_maiden_frostbite_lua", "heroes/hero_crystal_maiden/crystal_maiden_frostbite_lua/modifier_crystal_maiden_frostbite_lua", LUA_MODIFIER_MOTION_NONE )
