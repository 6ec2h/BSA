...
LinkLuaModifier( "modifier_crystal_maiden_crystal_nova_lua", "heroes/hero_crystal_maiden/crystal_maiden_crystal_nova_lua/modifier_crystal_maiden_crystal_nova_lua", LUA_MODIFIER_MOTION_NONE )


function crystal_maiden_crystal_nova_lua:GetCooldown( level )
...
function crystal_maiden_crystal_nova_lua:OnSpellStart()
	...
	if self:GetCaster():FindAbilityByName("npc_crystal_maiden_2")~=nil then
		if self:GetCaster():FindAbilityByName("npc_crystal_maiden_2"):GetLevel() > 0 then 
			damage = damage + 240
		end
	end
