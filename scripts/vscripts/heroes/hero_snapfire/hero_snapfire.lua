...
LinkLuaModifier( "modifier_lua_snapfire_scatterblast_slow", "heroes/hero_snapfire/hero_snapfire", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_lua_snapfire_scatterblast_silence", "heroes/hero_snapfire/hero_snapfire", LUA_MODIFIER_MOTION_NONE )
...
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
LinkLuaModifier( "modifier_lua_snapfire_firesnap_cookie_damage", "heroes/hero_snapfire/hero_snapfire", LUA_MODIFIER_MOTION_NONE )
...
function lua_snapfire_firesnap_cookie:OnProjectileHit( target, location )
	...
	target:AddNewModifier(self:GetCaster(), self, 'modifier_lua_snapfire_firesnap_cookie_damage', { duration = duration })
...
LinkLuaModifier( "modifier_lua_snapfire_mortimer_kisses_thinker", "heroes/hero_snapfire/hero_snapfire", LUA_MODIFIER_MOTION_NONE )
...
function lua_snapfire_mortimer_kisses:OnProjectileHit( target, location )
	...
	CreateModifierThinker(self:GetCaster(), self, "modifier_lua_snapfire_mortimer_kisses_thinker", {duration = duration}, target:GetOrigin(), self:GetCaster():GetTeamNumber(), false)
