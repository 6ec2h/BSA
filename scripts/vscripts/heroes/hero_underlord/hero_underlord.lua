...
LinkLuaModifier( "modifier_lua_abyssal_underlord_firestorm", "heroes/hero_underlord/hero_underlord", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_lua_abyssal_underlord_firestorm_thinker", "heroes/hero_underlord/hero_underlord", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_lua_abyssal_underlord_firestorm_slow", "heroes/hero_underlord/hero_underlord", LUA_MODIFIER_MOTION_NONE )
...
function lua_abyssal_underlord_firestorm:OnSpellStart()
	...
	local point = self:GetCursorPosition()
	CreateModifierThinker(caster, self, "modifier_lua_abyssal_underlord_firestorm_thinker", {}, point, caster:GetTeamNumber(), false)
end
...
function modifier_lua_abyssal_underlord_firestorm_thinker:OnIntervalThink()
	...
	for _,enemy in pairs(enemies) do
		...
		local modifier = enemy:AddNewModifier(self.caster, self.ability, "modifier_lua_abyssal_underlord_firestorm_slow", {duration = 1})
...
function modifier_lua_abyssal_underlord_firestorm_slow:OnCreated( kv )
end
...
LinkLuaModifier( "modifier_lua_abyssal_underlord_pit_of_malice", "heroes/hero_underlord/hero_underlord", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_lua_abyssal_underlord_pit_of_malice_cooldown", "heroes/hero_underlord/hero_underlord", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_lua_abyssal_underlord_pit_of_malice_thinker", "heroes/hero_underlord/hero_underlord", LUA_MODIFIER_MOTION_NONE )
...
function lua_abyssal_underlord_pit_of_malice:OnSpellStart()
	...
	CreateModifierThinker(caster, self, "modifier_lua_abyssal_underlord_pit_of_malice_thinker", { duration = duration }, point, caster:GetTeamNumber(), false)
end
...
function modifier_lua_abyssal_underlord_pit_of_malice_thinker:OnIntervalThink()
	...
	for _,enemy in pairs(enemies) do
		...
		if not modifier then
			enemy:AddNewModifier(self.caster, self:GetAbility(), "modifier_lua_abyssal_underlord_pit_of_malice", { duration = self.duration })
			self:PlayEffects()
		end
	end
end
...
function modifier_lua_abyssal_underlord_pit_of_malice_thinker:PlayEffects()
	...
	self.pfx = ParticleManager:CreateParticle( "particles/units/heroes/heroes_underlord/underlord_pitofmalice.vpcf", PATTACH_ABSORIGIN_FOLLOW, parent )
...
--------------------------------------------------------------------------------
modifier_lua_abyssal_underlord_pit_of_malice_cooldown = modifier_lua_abyssal_underlord_pit_of_malice_cooldown or class({})
...
function modifier_lua_abyssal_underlord_pit_of_malice_cooldown:OnCreated( kv )

end

function modifier_lua_abyssal_underlord_pit_of_malice_cooldown:OnRefresh( kv )
	
end

function modifier_lua_abyssal_underlord_pit_of_malice_cooldown:OnRemoved()
end

function modifier_lua_abyssal_underlord_pit_of_malice_cooldown:OnDestroy()
end
...
function modifier_lua_abyssal_underlord_pit_of_malice:OnCreated( kv )
	...
	self:GetParent():AddNewModifier(self:GetCaster(), self:GetAbility(), "modifier_lua_abyssal_underlord_pit_of_malice_cooldown", {duration = interval})
...
LinkLuaModifier( "modifier_lua_abyssal_underlord_atrophy_aura", "heroes/hero_underlord/hero_underlord", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_lua_abyssal_underlord_atrophy_aura_debuff", "heroes/hero_underlord/hero_underlord", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_lua_abyssal_underlord_atrophy_aura_stack", "heroes/hero_underlord/hero_underlord", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_lua_abyssal_underlord_atrophy_aura_permanent_stack", "heroes/hero_underlord/hero_underlord", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_lua_abyssal_underlord_atrophy_aura_scepter", "heroes/hero_underlord/hero_underlord", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_lua_abyssal_underlord_atrophy_aura_active", "heroes/hero_underlord/hero_underlord", LUA_MODIFIER_MOTION_NONE )
...
function modifier_lua_abyssal_underlord_atrophy_aura:OnDeath( params )
	...
	if not params.unit:FindModifierByNameAndCaster( "modifier_lua_abyssal_underlord_atrophy_aura_debuff", parent ) then return end

	bonus = self.creep_bonus
	duration = self.duration
	
	if not IsMyKilledBadGuys(parent, params) then return end
	
	self:SetStackCount( self:GetStackCount() + bonus )

	local modifier = parent:AddNewModifier(parent, self:GetAbility(), "modifier_lua_abyssal_underlord_atrophy_aura_stack", { duration = duration })
...
LinkLuaModifier( "modifier_lua_abyssal_underlord_dark_rift", "heroes/hero_underlord/hero_underlord", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_lua_abyssal_underlord_dark_rift_effect", "heroes/hero_underlord/hero_underlord", LUA_MODIFIER_MOTION_NONE )
...
function lua_abyssal_underlord_dark_rift:OnSpellStart()
	...
	CreateModifierThinker(caster, self, "modifier_lua_abyssal_underlord_dark_rift", {duration = duration}, point, caster:GetTeamNumber(), false)
end
...
function modifier_lua_abyssal_underlord_dark_rift:PlayEffects2()
	...
	self.effect_cast = ParticleManager:CreateParticle(  "particles/units/heroes/heroes_underlord/abbysal_underlord_darkrift_ambient.vpcf", PATTACH_ABSORIGIN_FOLLOW, parent )
...
function modifier_lua_abyssal_underlord_dark_rift:IsAura() 					return true end
function modifier_lua_abyssal_underlord_dark_rift:GetAuraSearchTeam() 		return DOTA_UNIT_TARGET_TEAM_FRIENDLY end
function modifier_lua_abyssal_underlord_dark_rift:GetAuraSearchFlags()		return DOTA_UNIT_TARGET_FLAG_MAGIC_IMMUNE_ENEMIES end
function modifier_lua_abyssal_underlord_dark_rift:GetAuraSearchType() 		return DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_HERO end
function modifier_lua_abyssal_underlord_dark_rift:GetAuraRadius() 			return self.radius end
function modifier_lua_abyssal_underlord_dark_rift:GetModifierAura()			return "modifier_lua_abyssal_underlord_dark_rift_effect" end
