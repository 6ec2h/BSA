LinkLuaModifier("modifier_lina_light_strike_array_lua", "heroes/hero_lina/lina_stun/lina_stun", LUA_MODIFIER_MOTION_NONE)
...
function lina_stun:OnSpellStart()
	...
	Timers:CreateTimer(function()
		...
		CreateModifierThinker(caster, self, "modifier_lina_light_strike_array_lua", {duration = delay}, point_loc, caster:GetTeamNumber(), false)
		points = points - 1
		if points > 0 then
			return delay
		else
