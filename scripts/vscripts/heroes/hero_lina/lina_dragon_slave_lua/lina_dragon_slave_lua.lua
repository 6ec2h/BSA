LinkLuaModifier( "modifier_lina_dragon_slave_lua_flame", "heroes/hero_lina/lina_dragon_slave_lua/lina_dragon_slave_lua", LUA_MODIFIER_MOTION_NONE )
...
function lina_dragon_slave_lua:OnProjectileHitHandle( target, location, projectile )
	...
	local damage_slave = self:GetSpecialValueFor( "damage" ) + self:GetCaster():ExtraIntelligenceDamage() * self:GetSpecialValueFor("ExtraIntelligenceDamage") 
