...
LinkLuaModifier( "modifier_tinker_laser_lua", "heroes/hero_tinker/tinker_laser_lua/modifier_tinker_laser_lua", LUA_MODIFIER_MOTION_NONE )
...
function tinker_laser_lua:OnSpellStart()
	...
	if self:GetCaster():FindAbilityByName("npc_dota_hero_tinker_int1")~=nil then
		if self:GetCaster():FindAbilityByName("npc_dota_hero_tinker_int1"):GetLevel() > 0 then
