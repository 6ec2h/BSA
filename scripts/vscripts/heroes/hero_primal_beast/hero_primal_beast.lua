LinkLuaModifier("modifier_primal_beast_rock_throw", "heroes/hero_primal_beast/hero_primal_beast", LUA_MODIFIER_MOTION_NONE)
...
function primal_beast_rock_throw_lua:SpawnRockShrapnel(position, target)
    ...
    for i = 1, shard_count do
        ...
        local shard_dummy = CreateModifierThinker(caster, self, nil, {duration = 2}, shard_target_pos, caster:GetTeamNumber(), false)
...
LinkLuaModifier( "modifier_primal_beast_trample_lua", "heroes/hero_primal_beast/hero_primal_beast", LUA_MODIFIER_MOTION_NONE )
...
LinkLuaModifier( "modifier_primal_beast_uproar_lua_buff", "heroes/hero_primal_beast/hero_primal_beast", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_primal_beast_uproar_lua_debuff", "heroes/hero_primal_beast/hero_primal_beast", LUA_MODIFIER_MOTION_NONE )
...
LinkLuaModifier( "modifier_primal_beast_pulverize_lua", "heroes/hero_primal_beast/hero_primal_beast", LUA_MODIFIER_MOTION_NONE )
...
function modifier_primal_beast_pulverize_lua:IsHidden() return false end
function modifier_primal_beast_pulverize_lua:IsPurgable() return false end
