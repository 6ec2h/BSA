...
LinkLuaModifier( "modifier_muerta_pierce_the_veil_lua", "heroes/hero_muerta/muerta_pierce_the_veil_lua/muerta_pierce_the_veil_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_muerta_pierce_the_veil_lua_undisarm", "heroes/hero_muerta/muerta_pierce_the_veil_lua/muerta_pierce_the_veil_lua", LUA_MODIFIER_MOTION_NONE )
