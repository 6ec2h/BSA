...
LinkLuaModifier( "modifier_hoodwink_acorn_shot_lua_thinker", "heroes/hero_hoodwink/hero_hoodwink", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_hoodwink_acorn_shot_lua_debuff", "heroes/hero_hoodwink/hero_hoodwink", LUA_MODIFIER_MOTION_NONE )
...
LinkLuaModifier( "modifier_hoodwink_bushwhack_lua_thinker", "heroes/hero_hoodwink/hero_hoodwink", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_hoodwink_bushwhack_lua_debuff", "heroes/hero_hoodwink/hero_hoodwink", LUA_MODIFIER_MOTION_HORIZONTAL )
	...
	Timers:CreateTimer(0, function()
		if self.current_count < self.count then
			self.current_count = self.current_count + 1
				...
				local velocity = RotatePosition(Vector(0,0,0), QAngle(0, angles[self.current_count], 0), caster:GetForwardVector()) * self.projectile_speed
