LinkLuaModifier("modifier_doom_bringer_devour_custom", "heroes/hero_doom_bringer/doom_bringer_devour_custom/doom_bringer_devour_custom", LUA_MODIFIER_MOTION_NONE)
