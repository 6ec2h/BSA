LinkLuaModifier( "modifier_doom_bringer_infernal_blade_custom", "heroes/hero_doom_bringer/doom_bringer_infernal_blade_custom/doom_bringer_infernal_blade_custom", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_doom_bringer_infernal_blade_custom_debuff", "heroes/hero_doom_bringer/doom_bringer_infernal_blade_custom/doom_bringer_infernal_blade_custom", LUA_MODIFIER_MOTION_NONE )
...
function doom_bringer_infernal_blade_custom:OnOrbImpact( params )
	...
	params.target:AddNewModifier( self:GetCaster(), self, "modifier_doom_bringer_infernal_blade_custom_debuff", { duration = duration } )
