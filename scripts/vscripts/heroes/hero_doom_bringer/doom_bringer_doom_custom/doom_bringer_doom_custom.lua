LinkLuaModifier("modifier_doom_bringer_doom_custom", "heroes/hero_doom_bringer/doom_bringer_doom_custom/doom_bringer_doom_custom", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_doom_bringer_doom_custom_aura", "heroes/hero_doom_bringer/doom_bringer_doom_custom/doom_bringer_doom_custom", LUA_MODIFIER_MOTION_NONE)
...
function modifier_doom_bringer_doom_custom:CheckState()
	local state = 
	{
        ...
        [MODIFIER_STATE_SPECIALLY_DENIABLE] = self:GetParent():GetHealthPercent() <= self:GetAbility():GetSpecialValueFor("deniable_pct"),
	}
	return state
end
