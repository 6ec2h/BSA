...
LinkLuaModifier( "modifier_omniknight_degen_aura_lua", "heroes/hero_omniknight/hero_omniknight", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_omniknight_degen_aura_lua_effect", "heroes/hero_omniknight/hero_omniknight", LUA_MODIFIER_MOTION_NONE )
...
LinkLuaModifier( "modifier_omniknight_guardian_angel_lua", "heroes/hero_omniknight/hero_omniknight", LUA_MODIFIER_MOTION_NONE )
