LinkLuaModifier( "modifier_slark_shadow_dance_custom", "heroes/hero_slark/slark_shadow_dance_custom/slark_shadow_dance_custom", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_slark_shadow_dance_custom_passive", "heroes/hero_slark/slark_shadow_dance_custom/slark_shadow_dance_custom", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_slark_shadow_dance_custom_attack", "heroes/hero_slark/slark_shadow_dance_custom/slark_shadow_dance_custom", LUA_MODIFIER_MOTION_NONE )
...
function modifier_slark_shadow_dance_custom_attack:IsPurgable() return false end