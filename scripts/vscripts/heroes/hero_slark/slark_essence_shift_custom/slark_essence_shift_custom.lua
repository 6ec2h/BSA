LinkLuaModifier( "modifier_slark_essence_shift_custom", "heroes/hero_slark/slark_essence_shift_custom/slark_essence_shift_custom", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_slark_essence_shift_custom_debuff", "heroes/hero_slark/slark_essence_shift_custom/slark_essence_shift_custom", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_slark_essence_shift_custom_debuff_stack", "heroes/hero_slark/slark_essence_shift_custom/slark_essence_shift_custom", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_slark_essence_shift_custom_stack", "heroes/hero_slark/slark_essence_shift_custom/slark_essence_shift_custom", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_slark_essence_shift_custom_buff", "heroes/hero_slark/slark_essence_shift_custom/slark_essence_shift_custom", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_slark_essence_shift_custom_permanent_debuff", "heroes/hero_slark/slark_essence_shift_custom/slark_essence_shift_custom", LUA_MODIFIER_MOTION_NONE )
...
function modifier_slark_essence_shift_custom:IsHidden() return self:GetStackCount() == 0 end
...
function modifier_slark_essence_shift_custom_debuff:IsHidden() return false end
...
function modifier_slark_essence_shift_custom_debuff:OnDeath(params)
	...
	if ((self:GetCaster():GetAbsOrigin() - target:GetAbsOrigin()):Length2D() <= 300) or (params.attacker and params.attacker == self:GetCaster()) then
