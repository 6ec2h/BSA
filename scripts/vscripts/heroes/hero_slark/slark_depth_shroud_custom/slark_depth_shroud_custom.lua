LinkLuaModifier( "modifier_slark_depth_shroud_custom_thinker", "heroes/hero_slark/slark_depth_shroud_custom/slark_depth_shroud_custom", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_slark_shadow_dance_custom_shard", "heroes/hero_slark/slark_depth_shroud_custom/slark_depth_shroud_custom", LUA_MODIFIER_MOTION_NONE )
