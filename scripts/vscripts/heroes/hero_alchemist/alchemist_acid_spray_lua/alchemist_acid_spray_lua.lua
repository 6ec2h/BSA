...
function modifier_alchemist_acid_spray_lua:OnCreated( kv )
	...
	if self:GetCaster():FindAbilityByName("npc_dota_hero_alchemist_agi2") ~= nil then 
		if self:GetCaster():FindAbilityByName("npc_dota_hero_alchemist_agi2"):GetLevel() > 0 then 
