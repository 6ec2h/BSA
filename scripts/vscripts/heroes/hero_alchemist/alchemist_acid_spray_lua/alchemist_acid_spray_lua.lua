...
LinkLuaModifier( "modifier_alchemist_acid_spray_lua_slow", "heroes/hero_alchemist/alchemist_acid_spray_lua/alchemist_acid_spray_lua", LUA_MODIFIER_MOTION_NONE )
