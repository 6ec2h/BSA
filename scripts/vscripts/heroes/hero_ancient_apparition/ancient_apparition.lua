LinkLuaModifier("modifier_ancient_apparition_cold_feet_lua_freeze", "heroes/hero_ancient_apparition/ancient_apparition", LUA_MODIFIER_MOTION_NONE)
...
function ancient_apparition_cold_feet_lua:OnSpellStart()
	...
	local enemies = FindUnitsInRadius( caster:GetTeamNumber(), target_point, nil, self:GetSpecialValueFor( "radius" ), DOTA_UNIT_TARGET_TEAM_ENEMY, DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC, DOTA_UNIT_TARGET_FLAG_MAGIC_IMMUNE_ENEMIES + DOTA_UNIT_TARGET_FLAG_NO_INVIS, FIND_CLOSEST, false )
...
LinkLuaModifier("modifier_ancient_apparition_ice_vortex_lua_aura", "heroes/hero_ancient_apparition/ancient_apparition", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_ancient_apparition_ice_vortex_lua_aura_effect", "heroes/hero_ancient_apparition/ancient_apparition", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_ancient_apparition_chilling_touch_lua", "heroes/hero_ancient_apparition/ancient_apparition", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier( "modifier_ancient_apparition_ice_blast_lua", "heroes/hero_ancient_apparition/ancient_apparition", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ancient_apparition_ice_blast_lua_slow", "heroes/hero_ancient_apparition/ancient_apparition", LUA_MODIFIER_MOTION_NONE )
