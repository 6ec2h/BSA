...
LinkLuaModifier( "modifier_earthshaker_enchant_totem_lua", "heroes/hero_earthshaker/earthshaker_enchant_totem_lua/modifier_earthshaker_enchant_totem_lua", LUA_MODIFIER_MOTION_NONE )
...
function earthshaker_enchant_totem_lua:OnAbilityPhaseStart()
	...
	arc:SetEndCallback(function()
		...
		-- do normal
		self:OnSpellStart()
		self:UseResources( false,true, false, true )
	end)
