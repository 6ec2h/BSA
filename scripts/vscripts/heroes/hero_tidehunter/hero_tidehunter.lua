...
function modifier_tidehunter_gush_lua:IsHidden() return false end
function modifier_tidehunter_gush_lua:IsDebuff() return true end
function modifier_tidehunter_gush_lua:IsPurgable() return true end
...
function modifier_tidehunter_gush_lua:GetModifierMoveSpeedBonus_Percentage() return self.slow end
function modifier_tidehunter_gush_lua:GetModifierPhysicalArmorBonus() return self.armor end
function modifier_tidehunter_gush_lua:GetEffectName() return "particles/units/heroes/hero_tidehunter/tidehunter_gush_slow.vpcf" end
function modifier_tidehunter_gush_lua:GetEffectAttachType() return PATTACH_ABSORIGIN_FOLLOW end

--------------------------------------------------------------------------------
--------------------------------------------------------------------------------

LinkLuaModifier( "modifier_tidehunter_kraken_shell_lua", "heroes/hero_tidehunter/hero_tidehunter", LUA_MODIFIER_MOTION_NONE )
...
function modifier_tidehunter_kraken_shell_lua:IsDebuff() return false end
function modifier_tidehunter_kraken_shell_lua:IsPurgable() return false end
function modifier_tidehunter_kraken_shell_lua:AllowIllusionDuplicate() return true end
...
function modifier_tidehunter_kraken_shell_lua:OnTakeDamage(params)
    ...
    if params.unit ~= self.parent or self.parent:PassivesDisabled() then return end
    if not self.ability or self.ability:IsNull() then return end
...
function modifier_tidehunter_kraken_shell_lua:PlayEffects()
    local effect = ParticleManager:CreateParticle("particles/units/heroes/hero_tidehunter/tidehunter_krakenshell_purge.vpcf", PATTACH_ABSORIGIN_FOLLOW, self.parent)
...
LinkLuaModifier( "modifier_tidehunter_anchor_smash_lua", "heroes/hero_tidehunter/hero_tidehunter", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_tidehunter_anchor_smash_lua_buff", "heroes/hero_tidehunter/hero_tidehunter", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_tidehunter_anchor_smash_lua_talent", "heroes/hero_tidehunter/hero_tidehunter", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_tidehunter_anchor_smash_lua_cd", "heroes/hero_tidehunter/hero_tidehunter", LUA_MODIFIER_MOTION_NONE )
...
function tidehunter_anchor_smash_lua:OnSpellStart()
    ...
    local buff = caster:AddNewModifier(caster, self, "modifier_tidehunter_anchor_smash_lua_buff", { bonus = bonus_damage })
...
function tidehunter_anchor_smash_lua:PlayEffects()
    local caster = self:GetCaster()
    local effect = ParticleManager:CreateParticle("particles/units/heroes/hero_tidehunter/tidehunter_anchor_hero.vpcf", PATTACH_WORLDORIGIN, nil)
...
function modifier_tidehunter_anchor_smash_lua:IsDebuff() return true end
...
function modifier_tidehunter_anchor_smash_lua_buff:IsHidden() return true end
function modifier_tidehunter_anchor_smash_lua_buff:IsPurgable() return false end
...
function modifier_tidehunter_anchor_smash_lua_buff:GetModifierPreAttack_BonusDamage() return self.bonus end
function modifier_tidehunter_anchor_smash_lua_buff:GetSuppressCleave() return 1 end

--------------------------------------------------------------------------------

modifier_tidehunter_anchor_smash_lua_talent = class({})

function modifier_tidehunter_anchor_smash_lua_talent:IsHidden() return true end
function modifier_tidehunter_anchor_smash_lua_talent:IsPurgable() return false end
...
function modifier_tidehunter_anchor_smash_lua_cd:IsHidden() return true end
function modifier_tidehunter_anchor_smash_lua_cd:IsPurgable() return false end
...
function tidehunter_ravage_lua:OnSpellStart()
    ...
    if ring then
        ring:SetCallback( function( enemy )
            local knockback = enemy:AddNewModifier( caster, self, "modifier_generic_arc_lua", { duration = 0.5, height = 350 } )
...
function tidehunter_ravage_lua:PlayEffectsCast( center, radius )
    local effect = ParticleManager:CreateParticle( "particles/units/heroes/hero_tidehunter/tidehunter_spell_ravage.vpcf", PATTACH_WORLDORIGIN, self:GetCaster() )
...
function tidehunter_ravage_lua:PlayEffectsHit( enemy )
    local effect = ParticleManager:CreateParticle( "particles/units/heroes/hero_tidehunter/tidehunter_spell_ravage_hit.vpcf", PATTACH_ABSORIGIN_FOLLOW, enemy )
    ParticleManager:ReleaseParticleIndex( effect )
end