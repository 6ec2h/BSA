...
LinkLuaModifier("modifier_terrorblade_reflection_lua_illusion", "heroes/hero_terror/hero_terror", LUA_MODIFIER_MOTION_NONE)
...
function modifier_terrorblade_reflection_lua:IsPurgable() return true end
...
function modifier_terrorblade_reflection_lua_illusion:IsHidden() return true end
...
LinkLuaModifier( "modifier_terrorblade_metamorphosis_lua_aura", "heroes/hero_terror/hero_terror", LUA_MODIFIER_MOTION_NONE )
...
function modifier_terrorblade_sunder_lua:IsHidden() return false end
function modifier_terrorblade_sunder_lua:IsPurgable() return false end
