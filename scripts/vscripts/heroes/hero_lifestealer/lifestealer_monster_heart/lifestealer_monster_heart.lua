...
LinkLuaModifier( "modifier_lifestealer_monster_heart", "heroes/hero_lifestealer/lifestealer_monster_heart/lifestealer_monster_heart", LUA_MODIFIER_MOTION_NONE )
