...
LinkLuaModifier( "modifier_lifestealer_open_wounds_lua", "heroes/hero_lifestealer/lifestealer_open_wounds_lua/modifier_lifestealer_open_wounds_lua", LUA_MODIFIER_MOTION_NONE )
