...
function phantom_assassin_phantom_strike_lua:OnSpellStart()
	...
	if target:GetModelName() == "models/items/earthshaker/totem_dragon_wall/fissure_body.vmdl" or target:GetModelName() == "models/source/machinegun.vmdl" then return end
