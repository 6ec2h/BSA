...
LinkLuaModifier( "modifier_sniper_shrapnel_lua_charges", "heroes/hero_sniper/sniper_shrapnel_lua/modifier_sniper_shrapnel_lua_charges", LUA_MODIFIER_MOTION_NONE )
