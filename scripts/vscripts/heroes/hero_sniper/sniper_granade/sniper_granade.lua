...
function sniper_granade:OnProjectileHit( target, vLocation )
    ...
    if target ~= nil then
		...
		if self:GetCaster():FindAbilityByName("npc_dota_hero_sniper_int11")~=nil then
			if self:GetCaster():FindAbilityByName("npc_dota_hero_sniper_int11"):GetLevel() > 0 then 
		...
		if self:GetCaster():FindAbilityByName("npc_dota_hero_sniper_int8")~=nil then
			if self:GetCaster():FindAbilityByName("npc_dota_hero_sniper_int8"):GetLevel() > 0 then 
