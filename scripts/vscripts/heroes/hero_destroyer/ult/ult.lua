...
function modifier_hero_destroyer_ult:IsHidden() return false end
function modifier_hero_destroyer_ult:IsDebuff() return true end
function modifier_hero_destroyer_ult:IsPurgable() return true end
