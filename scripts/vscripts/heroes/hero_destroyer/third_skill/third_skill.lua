LinkLuaModifier("modifier_hero_destroyer_third_skill", "heroes/hero_destroyer/third_skill/third_skill", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_hero_destroyer_third_skill_debuff", "heroes/hero_destroyer/third_skill/third_skill", LUA_MODIFIER_MOTION_NONE)
