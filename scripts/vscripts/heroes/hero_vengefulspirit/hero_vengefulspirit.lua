LinkLuaModifier( "modifier_vengefulspirit_magic_missile_lua", "heroes/hero_vengefulspirit/hero_vengefulspirit", LUA_MODIFIER_MOTION_NONE )
...
function vengefulspirit_magic_missile_lua:OnProjectileHit_ExtraData( hTarget, vLocation, extraData )
    if not hTarget or hTarget:IsInvulnerable() or hTarget:IsMagicImmune() then return true end
...
LinkLuaModifier( "modifier_vengefulspirit_wave_of_terror_lua", "heroes/hero_vengefulspirit/hero_vengefulspirit", LUA_MODIFIER_MOTION_NONE )
...
function modifier_vengefulspirit_wave_of_terror_lua:IsPurgable() return true end
...
LinkLuaModifier("modifier_vengefulspirit_command_aura_lua", "heroes/hero_vengefulspirit/hero_vengefulspirit", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_vengefulspirit_command_aura_effect_lua", "heroes/hero_vengefulspirit/hero_vengefulspirit", LUA_MODIFIER_MOTION_NONE)
...
function modifier_vengefulspirit_command_aura_lua:IsPurgable() return false end
...
function modifier_vengefulspirit_command_aura_effect_lua:IsHidden() return true end
function modifier_vengefulspirit_command_aura_effect_lua:IsPurgable() return false end
...
LinkLuaModifier( "modifier_vengefulspirit_nether_swap_lua", "heroes/hero_vengefulspirit/hero_vengefulspirit", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_vengefulspirit_nether_swap_lua_effect", "heroes/hero_vengefulspirit/hero_vengefulspirit", LUA_MODIFIER_MOTION_NONE )
