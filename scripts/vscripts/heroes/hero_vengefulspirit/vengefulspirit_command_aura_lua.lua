...
LinkLuaModifier( "modifier_vengefulspirit_command_aura_lua", "heroes/hero_vengefulspirit/vengefulspirit_command_aura_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_vengefulspirit_command_aura_effect_lua", "heroes/hero_vengefulspirit/vengefulspirit_command_aura_lua", LUA_MODIFIER_MOTION_NONE )
