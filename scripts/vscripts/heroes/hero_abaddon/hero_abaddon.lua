...
LinkLuaModifier('modifier_abaddon_curse_of_avernus_lua_debuff', "heroes/hero_abaddon/hero_abaddon", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier('modifier_abaddon_curse_of_avernus_lua_debuff_slow', "heroes/hero_abaddon/hero_abaddon", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier('modifier_abaddon_curse_of_avernus_lua', "heroes/hero_abaddon/hero_abaddon", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier('modifier_abaddon_curse_of_avernus_lua_buff', "heroes/hero_abaddon/hero_abaddon", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier('modifier_abaddon_borrowed_time_lua_active', "heroes/hero_abaddon/hero_abaddon", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier('modifier_abaddon_borrowed_time_lua_passive', "heroes/hero_abaddon/hero_abaddon", LUA_MODIFIER_MOTION_NONE)
