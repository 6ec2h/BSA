...
LinkLuaModifier( "modifier_drow_ranger_frost_arrows_lua", "heroes/hero_drow_ranger/hero_drow_ranger", LUA_MODIFIER_MOTION_NONE )
...
function drow_ranger_frost_arrows_lua:OnOrbImpact( params )
	...
	params.target:AddNewModifier(self:GetCaster(), self, "modifier_drow_ranger_frost_arrows_lua", { duration = duration })
...
LinkLuaModifier("modifier_drow_cross_damage_helper", "heroes/hero_drow_ranger/hero_drow_ranger", LUA_MODIFIER_MOTION_NONE)
...
function modifier_drow_cross_lua_active:OnCreated()
    local caster = self:GetCaster()
    self.pfx = ParticleManager:CreateParticle("particles/units/heroes/hero_drow/drow_glacier_hilltop_ramp_dryice.vpcf", PATTACH_ABSORIGIN_FOLLOW, caster)
...
function modifier_drow_cross_damage_helper:IsHidden() return true end
function modifier_drow_cross_damage_helper:OnCreated(keys)
    if IsServer() then self.pct = keys.pct end
end
...
LinkLuaModifier("modifier_drow_ranger_aura_debuff", "heroes/hero_drow_ranger/hero_drow_ranger", LUA_MODIFIER_MOTION_NONE)
...
function modifier_drow_ranger_aura_buff:OnRefresh() self:OnCreated() end
...
LinkLuaModifier("modifier_drow_ranger_marksmanship_lua", "heroes/hero_drow_ranger/hero_drow_ranger", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_drow_ranger_marksmanship_lua_aura_buff", "heroes/hero_drow_ranger/hero_drow_ranger", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_drow_ranger_marksmanship_lua_effect", "heroes/hero_drow_ranger/hero_drow_ranger", LUA_MODIFIER_MOTION_NONE)
...
function modifier_drow_ranger_marksmanship_lua:OnAttackStart(params)
    if not IsServer() then return end
    if params.attacker ~= self:GetParent() or params.target:IsOther() then return end
...
function modifier_drow_ranger_marksmanship_lua:GetModifierBonusStats_Agility()
    local parent = self:GetParent()
    if not parent or parent:PassivesDisabled() or self.agi_lock then return 0 end
...
function modifier_drow_ranger_marksmanship_lua:PlayEffects1()
    local pfx = ParticleManager:CreateParticle("particles/units/heroes/hero_drow/drow_marksmanship.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetParent())
