...
--------------------------------------------------------------------------------
function modifier_drow_ranger_marksmanship_lua_effect:IsHidden() return false end
function modifier_drow_ranger_marksmanship_lua_effect:IsDebuff() return false end
function modifier_drow_ranger_marksmanship_lua_effect:IsPurgable()	return false end
function modifier_drow_ranger_marksmanship_lua_effect:GetPriority() return MODIFIER_PRIORITY_LOW end
...
function modifier_drow_ranger_marksmanship_lua_effect:GetModifierDamageOutgoing_Percentage()
	...
	-- check if split shot
	if not self:GetAbility().split then return end
