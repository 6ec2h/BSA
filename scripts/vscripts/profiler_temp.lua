...
Timers:CreateTimer(10, function()
	local arr = {}
	for k, v in pairs(_G.PROF.sites) do arr[#arr + 1] = { k, v } end
	...
	local farr = {}
	for k, v in pairs(_G.PROF.funcs) do farr[#farr + 1] = { k, v } end
	table.sort(farr, function(a, b) return a[2] > b[2] end)
	for i = 1, #farr do
