LinkLuaModifier("modifier_imba_aether_lens2_passive", "items/custom_items/item_aether_kaya2.lua", LUA_MODIFIER_MOTION_NONE)
-------------------------------------------
...
function modifier_imba_aether_lens2_passive:IsDebuff() return false end
function modifier_imba_aether_lens2_passive:IsHidden() return true end
function modifier_imba_aether_lens2_passive:IsPermanent() return true end
function modifier_imba_aether_lens2_passive:IsPurgable() return false end
function modifier_imba_aether_lens2_passive:IsPurgeException() return false end
function modifier_imba_aether_lens2_passive:IsStunDebuff() return false end
function modifier_imba_aether_lens2_passive:RemoveOnDeath() return false end
function modifier_imba_aether_lens2_passive:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
function modifier_imba_aether_lens2_passive:OnDestroy()
