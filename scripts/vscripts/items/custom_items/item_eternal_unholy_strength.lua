...
LinkLuaModifier("modifier_item_eternal_unholy_strength",           "items/custom_items/item_eternal_unholy_strength.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_eternal_unholy_str_active_1",       "items/custom_items/item_eternal_unholy_strength.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_eternal_unholy_str_active_2",       "items/custom_items/item_eternal_unholy_strength.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_eternal_unholy_str_active_3",       "items/custom_items/item_eternal_unholy_strength.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_eternal_unholy_str_toggle_prevent", "items/custom_items/item_eternal_unholy_strength.lua", LUA_MODIFIER_MOTION_NONE)
...
function item_eternal_unholy_strength_1:OnSpellStart()
	...
	if _has_higher_tier(caster, level) then return end
...
function modifier_item_eternal_unholy_strength:IsHidden() return true end
function modifier_item_eternal_unholy_strength:IsPurgable() return false end
function modifier_item_eternal_unholy_strength:GetAttributes() return MODIFIER_ATTRIBUTE_MULTIPLE end
...
function modifier_item_eternal_unholy_strength:GetModifierPreAttack_BonusDamage()
	if self._blocked then return 0 end
...
function modifier_item_eternal_unholy_str_active_1:IsHidden() return true end
function modifier_item_eternal_unholy_str_active_1:IsPurgable() return false end
...
function modifier_item_eternal_unholy_str_toggle_prevent:IsHidden() return true end
function modifier_item_eternal_unholy_str_toggle_prevent:IsPurgable() return false end
