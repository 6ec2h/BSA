...
function modifier_item_emerald_shell:IsHidden() return true end
function modifier_item_emerald_shell:IsPurgable() return false end
function modifier_item_emerald_shell:GetAttributes() return MODIFIER_ATTRIBUTE_MULTIPLE end
...
function modifier_item_emerald_shell:GetModifierBonusStats_Strength() return self.bonus_strength end
function modifier_item_emerald_shell:GetModifierBonusStats_Agility() return self.bonus_agility end
function modifier_item_emerald_shell:GetModifierBonusStats_Intellect() return self.bonus_intelligence end
function modifier_item_emerald_shell:GetModifierPreAttack_BonusDamage() return self.bonus_damage end
function modifier_item_emerald_shell:GetModifierConstantHealthRegen() return self.bonus_health_regen end
function modifier_item_emerald_shell:GetModifierConstantManaRegen() return self.bonus_mana_regen end
...
function modifier_item_emerald_shell_ready:IsHidden() return false end
function modifier_item_emerald_shell_ready:IsPurgable() return false end
function modifier_item_emerald_shell_ready:GetTexture() return "new/item_emerald_shell_2" end

--------------------------------------------------------------------------------

modifier_item_emerald_shell_block = class({})
function modifier_item_emerald_shell_block:IsHidden() return false end
function modifier_item_emerald_shell_block:IsDebuff() return true end
function modifier_item_emerald_shell_block:IsPurgable() return false end
function modifier_item_emerald_shell_block:RemoveOnDeath() return false end
function modifier_item_emerald_shell_block:GetTexture() return "new/item_emerald_shell_3" end

--------------------------------------------------------------------------------

modifier_item_emerald_shell_active = class({})

function modifier_item_emerald_shell_active:IsHidden() return false end
function modifier_item_emerald_shell_active:IsPurgable() return false end
...
function modifier_item_emerald_shell_active:GetModifierModelScale() return self.model_scale or 30 end