...
function modifier_item_guardian_greaves_lua:IsHidden()			return true end
...
function modifier_item_guardian_greaves_lua_aura_emitter:IsAura() return true end
function modifier_item_guardian_greaves_lua_aura_emitter:IsHidden() return true end
function modifier_item_guardian_greaves_lua_aura_emitter:IsDebuff() return false end
...
function modifier_item_guardian_greaves_lua_aura:IsHidden() return false end
...
function modifier_item_guardian_greaves_lua_heal:IsHidden() return false end
