...
LinkLuaModifier("modifier_item_bloodletter_prevention", "items/custom_items/item_bloodletter.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_bloodletter_active_1",   "items/custom_items/item_bloodletter.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_bloodletter_active_2",   "items/custom_items/item_bloodletter.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_bloodletter_active_3",   "items/custom_items/item_bloodletter.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_bloodletter_corrosion",  "items/custom_items/item_bloodletter.lua", LUA_MODIFIER_MOTION_NONE)
...
function item_bloodletter_1:OnSpellStart()
	...
	if caster:HasModifier("modifier_item_bloodletter_prevention") then return end
...
function modifier_item_bloodletter:IsHidden()      return true  end
function modifier_item_bloodletter:IsPurgable()    return false end
function modifier_item_bloodletter:GetAttributes() return MODIFIER_ATTRIBUTE_MULTIPLE end
...
function modifier_item_bloodletter:GetModifierPreAttack_BonusDamage()     return self.bonus_damage       end
function modifier_item_bloodletter:GetModifierAttackSpeedBonus_Constant() return self.bonus_attack_speed end
...
function modifier_item_bloodletter_prevention:IsHidden()   return true  end
function modifier_item_bloodletter_prevention:IsPurgable() return false end
...
function modifier_item_bloodletter_active_1:IsHidden()   return false end
function modifier_item_bloodletter_active_1:IsPurgable() return true  end
...
function modifier_item_bloodletter_corrosion:IsHidden()   return false end
function modifier_item_bloodletter_corrosion:IsPurgable() return true  end
function modifier_item_bloodletter_corrosion:IsDebuff()   return true  end
