...
LinkLuaModifier("modifier_item_arcane_singularity", "items/custom_items/item_arcane_singularity.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_arcane_singularity_thinker", "items/custom_items/item_arcane_singularity.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_arcane_singularity_pull", "items/custom_items/item_arcane_singularity.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_item_arcane_singularity:IsHidden() return true end
function modifier_item_arcane_singularity:IsPurgable() return false end
function modifier_item_arcane_singularity:GetAttributes() return MODIFIER_ATTRIBUTE_MULTIPLE end
...
function modifier_item_arcane_singularity_thinker:IsAura() return true end
function modifier_item_arcane_singularity_thinker:GetModifierAura() return "modifier_item_arcane_singularity_pull" end
function modifier_item_arcane_singularity_thinker:GetAuraRadius() return self.radius end
function modifier_item_arcane_singularity_thinker:GetAuraSearchTeam() return DOTA_UNIT_TARGET_TEAM_ENEMY end
function modifier_item_arcane_singularity_thinker:GetAuraSearchType() return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC end
function modifier_item_arcane_singularity_thinker:GetAuraSearchFlags() return DOTA_UNIT_TARGET_FLAG_NONE end

--------------------------------------------------------------------------------

modifier_item_arcane_singularity_pull = class({})

function modifier_item_arcane_singularity_pull:IsHidden() return false end
function modifier_item_arcane_singularity_pull:IsStunDebuff() return true end
