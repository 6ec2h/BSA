...
function modifier_item_devastator_lua:IsHidden() return true end
function modifier_item_devastator_lua:IsPurgable() return false end
function modifier_item_devastator_lua:RemoveOnDeath() return false end
...
function modifier_item_devastator_lua_debuff:IsHidden() return false end
function modifier_item_devastator_lua_debuff:IsPurgable() return false end
function modifier_item_devastator_lua_debuff:RemoveOnDeath() return false end
function modifier_item_devastator_lua_debuff:GetAttributes() return MODIFIER_ATTRIBUTE_MULTIPLE end
