...
function modifier_battlemage_arsenal:IsHidden()	return true end
function modifier_battlemage_arsenal:IsPurgable() return false end
...
function modifier_battlemage_arsenal_attack_buff:IsHidden()	return false end
function modifier_battlemage_arsenal_attack_buff:IsPurgable() return false end
...
function modifier_battlemage_arsenal_attack_buff:GetModifierTotalDamageOutgoing_Percentage( params )
	...
	if params.attacker:HasModifier("modifier_muerta_pierce_the_veil_lua") then return end
