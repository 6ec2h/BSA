...
function modifier_item_saintly_bulwark:IsHidden() return true end
function modifier_item_saintly_bulwark:IsPurgable() return false end
function modifier_item_saintly_bulwark:RemoveOnDeath() return false end
function modifier_item_saintly_bulwark:GetAttributes() return MODIFIER_ATTRIBUTE_MULTIPLE end
...
function modifier_item_saintly_bulwark:GetModifierBonusStats_Strength() return self.bonus_all_stats or 0 end
function modifier_item_saintly_bulwark:GetModifierBonusStats_Agility() return self.bonus_all_stats or 0 end
function modifier_item_saintly_bulwark:GetModifierBonusStats_Intellect() return self.bonus_all_stats or 0 end
function modifier_item_saintly_bulwark:GetModifierHealthBonus() return self.bonus_health or 0 end
function modifier_item_saintly_bulwark:GetModifierConstantHealthRegen() return self.bonus_health_regen or 0 end

function modifier_item_saintly_bulwark:GetModifierPhysical_ConstantBlock(keys)
    if not IsServer() then return 0 end
    if not keys or keys.damage_category ~= DOTA_DAMAGE_CATEGORY_ATTACK then return 0 end
    if self.block_damage <= 0 then return 0 end
