...
function modifier_item_solar_flare:IsHidden() return true end
function modifier_item_solar_flare:IsPurgable() return false end
function modifier_item_solar_flare:GetAttributes() return MODIFIER_ATTRIBUTE_MULTIPLE end
...
function modifier_item_solar_flare:IsAura() return true end
function modifier_item_solar_flare:GetModifierAura() return "modifier_item_solar_flare_aura" end
function modifier_item_solar_flare:GetAuraSearchTeam() return DOTA_UNIT_TARGET_TEAM_ENEMY end
function modifier_item_solar_flare:GetAuraSearchType() return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC end
function modifier_item_solar_flare:GetAuraSearchFlags() return DOTA_UNIT_TARGET_FLAG_NONE end
function modifier_item_solar_flare:GetAuraDuration() return 0.3 end
...
function modifier_item_solar_flare_aura:IsHidden() return true end
function modifier_item_solar_flare_aura:IsPurgable() return false end
