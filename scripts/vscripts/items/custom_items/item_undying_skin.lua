...
LinkLuaModifier("modifier_item_undying_skin_debuff", 'items/custom_items/item_undying_skin.lua', LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_undying_skin_debuff_slow", 'items/custom_items/item_undying_skin.lua', LUA_MODIFIER_MOTION_NONE)
