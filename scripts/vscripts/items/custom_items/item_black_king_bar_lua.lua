LinkLuaModifier("modifier_item_black_king_bar_lua", "items/custom_items/item_black_king_bar_lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_black_king_bar_lua_buff", "items/custom_items/item_black_king_bar_lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_item_black_king_bar_lua:IsHidden()return true end
function modifier_item_black_king_bar_lua:IsPurgable() return false end
function modifier_item_black_king_bar_lua:RemoveOnDeath() return false end
