...
function item_des_blade:OnSpellStart()
	self:GetCaster():AddNewModifier(self:GetCaster(), self, "modifier_item_des_blade_effect", { duration =  self:GetSpecialValueFor("duration")})
end
...
function modifier_item_des_blade_effect:IsHidden() return true end
function modifier_item_des_blade_effect:IsPurgable() return false end
function modifier_item_des_blade_effect:RemoveOnDeath()	return false end
