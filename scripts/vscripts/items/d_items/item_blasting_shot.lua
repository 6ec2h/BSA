...
function modifier_item_blasting_shot_passive:IsDebuff() return false end
function modifier_item_blasting_shot_passive:IsHidden() return true end
function modifier_item_blasting_shot_passive:IsPermanent() return true end
function modifier_item_blasting_shot_passive:IsPurgable() return false end
function modifier_item_blasting_shot_passive:IsPurgeException() return false end
function modifier_item_blasting_shot_passive:IsStunDebuff() return false end
function modifier_item_blasting_shot_passive:RemoveOnDeath() return false end
function modifier_item_blasting_shot_passive:AllowIllusionDuplicate() return false end
...
function modifier_item_blasting_shot_passive:OnAttackLanded(keys)
    if IsServer() then
        ...
        if (not parent:HasModifier("modifier_item_blasting_shot_cooldown")) and parent:IsRealHero() and parent:IsRangedAttacker() then
            parent:AddNewModifier(parent, ability, "modifier_item_blasting_shot_cooldown", {duration = ability:GetSpecialValueFor("internal_cooldown")})
...
function modifier_item_blasting_shot_cooldown:IsHidden() return false end
function modifier_item_blasting_shot_cooldown:IsDebuff() return false end
function modifier_item_blasting_shot_cooldown:IsPurgable() return false end
function modifier_item_blasting_shot_cooldown:IsPermanent() return true end
