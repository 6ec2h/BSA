...
function item_bkb_flask:OnProjectileHit(target, location)
    ...
    local explosion_pfx = ParticleManager:CreateParticle("particles/units/heroes/hero_alchemist/alchemist_unstable_concoction_explosion.vpcf", PATTACH_WORLDORIGIN, nil)
...
modifier_immune_bkb_flask_cd = class({
    ...
    GetTexture = function() return "item_bkb_flask" end,
})
...
modifier_immune_bkb_flask = class({
    ...
    IsDebuff = function() return false end,
    GetTexture = function() return "item_bkb_flask" end,
    GetEffectName = function() return "particles/bkb_flask.vpcf" end,
