...
LinkLuaModifier( "modifier_talisman_of_evasion_active", "items/d_items/item_talisman_of_evasion", LUA_MODIFIER_MOTION_NONE )
...
function modifier_talisman_of_evasion_active:OnDestroy()
end
