...
function modifier_critical_ring:OnCreated( kv )
...
function modifier_critical_ring:OnTakeDamage( params )
	  if IsServer() then
		...
		SendOverheadEventMessage( params.attacker, OVERHEAD_ALERT_BONUS_SPELL_DAMAGE , params.unit, params.damage * 2, nil )
	end
	return 0
end