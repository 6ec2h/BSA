...
function item_dark_stick:OnSpellStart()
	...
	SendOverheadEventMessage(caster, OVERHEAD_ALERT_GOLD, caster, current_charges * self:GetSpecialValueFor("gold_per_kill"), nil)
...
function modifier_item_dark_stick:OnDeath(params)
	...
	if not params.unit:FindModifierByNameAndCaster( "modifier_item_dark_stick_debuff", parent ) then return end
