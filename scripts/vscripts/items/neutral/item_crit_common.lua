...
function modifier_item_crit_common:IsHidden()		return true end
function modifier_item_crit_common:IsPurgable()		return false end
function modifier_item_crit_common:RemoveOnDeath()	return false end
function modifier_item_crit_common:GetAttributes()	return MODIFIER_ATTRIBUTE_MULTIPLE end
...
function modifier_item_crit_common:OnDestroy( kv )
