...
function modifier_item_crit_rare:IsHidden()		return true end
function modifier_item_crit_rare:IsPurgable()		return false end
function modifier_item_crit_rare:RemoveOnDeath()	return false end
function modifier_item_crit_rare:GetAttributes()	return MODIFIER_ATTRIBUTE_MULTIPLE end
...
function modifier_item_crit_rare:OnDestroy( kv )
