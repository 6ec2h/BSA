...
function modifier_item_crit_legendary:IsHidden()		return true end
function modifier_item_crit_legendary:IsPurgable()		return false end
function modifier_item_crit_legendary:RemoveOnDeath()	return false end
function modifier_item_crit_legendary:GetAttributes()	return MODIFIER_ATTRIBUTE_MULTIPLE end
...
function modifier_item_crit_legendary:OnDestroy( kv )
