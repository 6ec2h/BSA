...
LinkLuaModifier("modifier_item_boots_speed_legendary", "items/neutral/item_boots_speed_legendary.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_boots_speed_legendary_aura_positive", "items/neutral/item_boots_speed_legendary.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_boots_speed_legendary_aura_positive_effect", "items/neutral/item_boots_speed_legendary.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_item_boots_speed_legendary:IsHidden()		return true end
function modifier_item_boots_speed_legendary:IsPurgable()		return false end
function modifier_item_boots_speed_legendary:RemoveOnDeath()	return false end
function modifier_item_boots_speed_legendary:GetAttributes()	return MODIFIER_ATTRIBUTE_MULTIPLE end
...
function modifier_item_boots_speed_legendary:OnCreated()
	...
	if not self:GetCaster():HasModifier("modifier_item_boots_speed_legendary_aura_positive") then
		self:GetCaster():AddNewModifier(self:GetCaster(), self:GetAbility(), "modifier_item_boots_speed_legendary_aura_positive", {})
	end
end
...
function modifier_item_boots_speed_legendary_aura_positive:IsDebuff() return false end
function modifier_item_boots_speed_legendary_aura_positive:AllowIllusionDuplicate() return true end
function modifier_item_boots_speed_legendary_aura_positive:IsHidden() return true end
function modifier_item_boots_speed_legendary_aura_positive:IsPurgable() return false end
...
function modifier_item_boots_speed_legendary_aura_positive_effect:IsHidden() return true end
function modifier_item_boots_speed_legendary_aura_positive_effect:IsPurgable() return false end
function modifier_item_boots_speed_legendary_aura_positive_effect:IsDebuff() return false end
