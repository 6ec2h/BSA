...
LinkLuaModifier("modifier_item_boots_speed_rare_aura_positive", "items/neutral/item_boots_speed_rare.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_boots_speed_rare_aura_positive_effect", "items/neutral/item_boots_speed_rare.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_item_boots_speed_rare:IsHidden()		return true end
function modifier_item_boots_speed_rare:IsPurgable()		return false end
function modifier_item_boots_speed_rare:RemoveOnDeath()	return false end
function modifier_item_boots_speed_rare:GetAttributes()	return MODIFIER_ATTRIBUTE_MULTIPLE end
...
function modifier_item_boots_speed_rare:OnCreated()
	...
	if not self:GetCaster():HasModifier("modifier_item_boots_speed_rare_aura_positive") then
		self:GetCaster():AddNewModifier(self:GetCaster(), self:GetAbility(), "modifier_item_boots_speed_rare_aura_positive", {})
	end
end
...
function modifier_item_boots_speed_rare_aura_positive:IsDebuff() return false end
function modifier_item_boots_speed_rare_aura_positive:AllowIllusionDuplicate() return true end
function modifier_item_boots_speed_rare_aura_positive:IsHidden() return true end
function modifier_item_boots_speed_rare_aura_positive:IsPurgable() return false end
...
function modifier_item_boots_speed_rare_aura_positive_effect:IsHidden() return true end
function modifier_item_boots_speed_rare_aura_positive_effect:IsPurgable() return false end
function modifier_item_boots_speed_rare_aura_positive_effect:IsDebuff() return false end
