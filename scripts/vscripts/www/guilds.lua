...
function guilds:init()
	...
	self:RegisterHudListener( "reset_guild", "reset_guild" )
end
...
function guilds:add_member(t)
	...
	arr = json.encode(arr)
	local req = CreateHTTPRequestScriptVM( "POST", _G.host.."/api_guilds_add_member/?key=".._G.key )
...
function guilds:remove_member(t)
	arr = {sid = t.sid}
	arr = json.encode(arr)
	local req = CreateHTTPRequestScriptVM( "POST", _G.host.."/api_guilds_remove_member/?key=".._G.key )
	req:SetHTTPRequestGetOrPostParameter('arr',arr)
	req:SetHTTPRequestAbsoluteTimeoutMS(100000)
	req:Send(function(res)
		if res.StatusCode == 200 and res.Body ~= nil then
...
function guilds:add_reward_point(t)
	...
	arr = json.encode(arr)
	local req = CreateHTTPRequestScriptVM( "POST", _G.host.."/api_guilds_add_reward_point/?key=".._G.key )
	req:SetHTTPRequestGetOrPostParameter('arr',arr)
	req:SetHTTPRequestAbsoluteTimeoutMS(100000)
	req:Send(function(res)
		if res.StatusCode == 200 and res.Body ~= nil then
...
function guilds:add_guild_exp(pid, experience)
	...
	arr = json.encode(arr)
	local req = CreateHTTPRequestScriptVM( "POST", _G.host.."/api_guilds_add_guild_exp/?key=".._G.key )
	req:SetHTTPRequestGetOrPostParameter('arr',arr)
	req:SetHTTPRequestAbsoluteTimeoutMS(100000)
	req:Send(function(res)
		if res.StatusCode == 200 and res.Body ~= nil then
...
function guilds:buy_permanent_reward(t)
	...
	local sid = PlayerResource:GetSteamAccountID(t.PlayerID)
		...
		arr = json.encode(arr)
		local req = CreateHTTPRequestScriptVM( "POST", _G.host.."/api_buy_permanent_reward/?key=".._G.key )
		req:SetHTTPRequestGetOrPostParameter('arr',arr)
		req:SetHTTPRequestAbsoluteTimeoutMS(100000)
		req:Send(function(res)
			if res.StatusCode == 200 and res.Body ~= nil then
...
function guilds:buy_slot(t)
	...
	if tonumber(Shop.pShop[sid].coins) >= 20 then
		...
		arr = json.encode(arr)
		local req = CreateHTTPRequestScriptVM( "POST", _G.host.."/api_buy_slot/?key=".._G.key )
		req:SetHTTPRequestGetOrPostParameter('arr',arr)
		req:SetHTTPRequestAbsoluteTimeoutMS(100000)
		req:Send(function(res)
			if res.StatusCode == 200 and res.Body ~= nil then
...
function guilds:reset_guild(t)
	...
	if tonumber(Shop.pShop[sid].coins) >= 50 then
		...
		arr = json.encode(arr)
		local req = CreateHTTPRequestScriptVM( "POST", _G.host.."/api_reset_guild/?key=".._G.key )
		req:SetHTTPRequestGetOrPostParameter('arr',arr)
		req:SetHTTPRequestAbsoluteTimeoutMS(100000)
		req:Send(function(res)
			if res.StatusCode == 200 and res.Body ~= nil then
...
function guilds:create_game_guilds(t)
	...
	if tonumber(Shop.pShop[sid].coins) >= 200 then
		...
		arr = json.encode(arr)
		local req = CreateHTTPRequestScriptVM( "POST", _G.host.."/api_guilds_game_create/?key=".._G.key )
		req:SetHTTPRequestGetOrPostParameter('arr',arr)
		req:SetHTTPRequestAbsoluteTimeoutMS(100000)
		req:Send(function(res)
			if res.StatusCode == 200 and res.Body ~= nil then
...
function guilds:get_game_guilds(t)
	...
	arr = json.encode(arr)
	local req = CreateHTTPRequestScriptVM( "GET", _G.host.."/api_guilds_game3/")
	req:SetHTTPRequestGetOrPostParameter('arr',arr)
	req:SetHTTPRequestAbsoluteTimeoutMS(100000)
	req:Send(function(res)
		if res.StatusCode == 200 and res.Body ~= nil then
		...
		if res.StatusCode == 200 and res.Body ~= nil then
			...
			Timers:CreateTimer(0, function() 
				if PlayerResource:GetSelectedHeroEntity( pid ) then
					guilds:update_modifiers(guild.has_guild == true, guild, pid, true)
					return nil
				end
				return 0.2
			end)
...
function guilds:send_message(t)
	...
	arr = json.encode(arr)
	local req = CreateHTTPRequestScriptVM( "POST", _G.host.."/api_guilds_add_message/?key=".._G.key )
	req:SetHTTPRequestGetOrPostParameter('arr',arr)
	req:SetHTTPRequestAbsoluteTimeoutMS(100000)
	req:Send(function(res)
		if res.StatusCode == 200 and res.Body ~= nil then
...
function guilds:update_chat_message(t)
	...
	arr = json.encode(arr)
	local req = CreateHTTPRequestScriptVM( "POST", _G.host.."/api_guilds_update_chat_message/?key=".._G.key )
	req:SetHTTPRequestGetOrPostParameter('arr',arr)
	req:SetHTTPRequestAbsoluteTimeoutMS(100000)
	req:Send(function(res)
		if res.StatusCode == 200 and res.Body ~= nil then
