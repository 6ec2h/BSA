function Spawn( entityKeyValues )
	...
	if thisEntity == nil then
		...
		PointAbility = thisEntity:FindAbilityByName( "morphling_waveform" )
		NoTargetAbility = thisEntity:FindAbilityByName( "morph_heal" )
...
function MorphThink()
	...
	if NoTargetAbility ~= nil and NoTargetAbility:IsFullyCastable() and thisEntity:GetHealthPercent() < 25 then
		NoTargetAbilityCast()
	end
