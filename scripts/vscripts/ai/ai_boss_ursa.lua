boss_ursa_active = {"boss_ursa_earthshock_lua","ursa_enrage","boss_ursa_overpower_lua"}
...
function CreepThink()
	...
	if not thisEntity.bInitialized then
		thisEntity.vInitialSpawnPos = Vector(-12389,-11284,352)
	...
	if #enemies > 0 then
		...
		local random_skill = boss_ursa_active[RandomInt(1, #boss_ursa_active)]
