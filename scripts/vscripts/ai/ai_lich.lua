boss_lich_skills = {"boss_lich_frost_blast_lua","boss_lich_chain_frost_lua", "lich_sinister_gaze"}
...
function CreepThink()
	...
	if #enemies > 0 then
		...
		local random_skill = boss_lich_skills[RandomInt(1, #boss_lich_skills)]
