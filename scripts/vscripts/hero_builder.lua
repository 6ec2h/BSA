...
function HeroBuilder:GetSpeelsForSwapPanel(t)
	CustomGameEventManager:Send_ServerToPlayer(PlayerResource:GetPlayer(t.PlayerID), "GetPlayerSwapPanel", {player_abilities = HeroBuilder:GetPlayerSpells(t.PlayerID)})
end
