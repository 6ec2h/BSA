...
function creeps_spawn()     
    ...
    local special_ursa_indices = {[1]=true, [3]=true, [5]=true, [6]=true, [7]=true, [8]=true, [10]=true, [12]=true}

    local count_first = 0
    Timers:CreateTimer(0, function()
		count_first = count_first + 1
        if count_first > 15 then return nil end
    ...
    Timers:CreateTimer(0, function()
        ...
        if count_second > 13 then return nil end
