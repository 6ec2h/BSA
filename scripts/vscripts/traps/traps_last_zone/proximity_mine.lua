LinkLuaModifier("modifier_proximity_mine", "traps/traps_last_zone/proximity_mine.lua", LUA_MODIFIER_MOTION_NONE)

proximity_mine = class({})

function proximity_mine:GetIntrinsicModifierName()
    return "modifier_proximity_mine"
end

-------------------------------------------------------------------------

modifier_proximity_mine = class({})
