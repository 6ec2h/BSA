breathe_poison_room = class({})

--------------------------------------------------------------------------------

function breathe_poison_room:OnSpellStart()
	...
	local effect_name = "particles/units/heroes/hero_demonartist/demonartist_darkartistry_proj.vpcf" --"particles/units/heroes/hero_venomancer/venomancer_venomous_gale.vpcf" ---          particles/units/heroes/hero_venomancer/venomancer_venomous_gale.vpcf
	...
	ProjectileManager:CreateLinearProjectile( info )
			EmitSoundOn("Hero_Grimstroke.DarkArtistry.Cast.Layer", self:GetCaster() )
            EmitSoundOn("Hero_Grimstroke.DarkArtistry.Cast", self:GetCaster() )
            EmitSoundOn("Hero_Grimstroke.DarkArtistry.Projectile", self:GetCaster() )
end

--------------------------------------------------------------------------------

function breathe_poison_room:OnProjectileHit( hTarget, vLocation )
